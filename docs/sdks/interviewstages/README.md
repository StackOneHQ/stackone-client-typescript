...
* [atsInterviewStagesGet](#atsinterviewstagesget) - Get Interview Stage
* [atsInterviewStagesList](#atsinterviewstageslist) - List Interview Stages

## atsInterviewStagesGet
...
(async() => {
  ...
  const res = await sdk.interviewStages.atsInterviewStagesGet({
    id: "<ID>",
    proxy: {
      "key": "string",
    },
...
(async() => {
  ...
  const res = await sdk.interviewStages.atsInterviewStagesList({
    proxy: {
      "key": "string",
    },
    xAccountId: "string",
