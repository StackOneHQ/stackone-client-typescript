...
* [marketingCampaignsGet](#marketingcampaignsget) - Get campaign
* [marketingCampaignsList](#marketingcampaignslist) - List campaigns
...
(async() => {
  ...
  const res = await sdk.campaigns.marketingCampaignsGet({
    id: "<ID>",
    proxy: {
      "key": "string",
    },
...
(async() => {
  ...
  const res = await sdk.campaigns.marketingCampaignsList({
    proxy: {
      "key": "string",
    },
    xAccountId: "string",
