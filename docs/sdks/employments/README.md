...
* [hrisEmploymentsGet](#hrisemploymentsget) - Get Employment
* [hrisEmploymentsList](#hrisemploymentslist) - List Employments
...
(async() => {
  ...
  const res = await sdk.employments.hrisEmploymentsGet({
    id: "<ID>",
    proxy: {
      "key": "string",
    },
...
(async() => {
  ...
  const res = await sdk.employments.hrisEmploymentsList({
    proxy: {
      "key": "string",
    },
    xAccountId: "string",
