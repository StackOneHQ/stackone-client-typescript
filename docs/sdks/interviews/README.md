...
* [atsInterviewsGet](#atsinterviewsget) - Get Interview
* [atsInterviewsList](#atsinterviewslist) - List Interviews
...
(async() => {
  ...
  const res = await sdk.interviews.atsInterviewsGet({
    id: "<ID>",
    proxy: {
      "key": "string",
    },
...
(async() => {
  ...
  const res = await sdk.interviews.atsInterviewsList({
    proxy: {
      "key": "string",
    },
    xAccountId: "string",
