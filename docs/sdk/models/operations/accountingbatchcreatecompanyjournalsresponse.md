...
```typescript
import { AccountingBatchCreateCompanyJournalsResponse } from "@stackone/stackone-client-ts/sdk/models/operations";

let value: AccountingBatchCreateCompanyJournalsResponse = {
  contentType: "<value>",
  headers: {
    "key": [
      "<value 1>",
