...
```typescript
import { AccountingListCompaniesQueryParamFilter } from "@stackone/stackone-client-ts/sdk/models/operations";

let value: AccountingListCompaniesQueryParamFilter = {
