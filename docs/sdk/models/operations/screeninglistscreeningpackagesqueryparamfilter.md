...
```typescript
import { ScreeningListScreeningPackagesQueryParamFilter } from "@stackone/stackone-client-ts/sdk/models/operations";

let value: ScreeningListScreeningPackagesQueryParamFilter = {
