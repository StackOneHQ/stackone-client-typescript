...
```typescript
import { AtsListApplicationStagesQueryParamFilter } from "@stackone/stackone-client-ts/sdk/models/operations";

let value: AtsListApplicationStagesQueryParamFilter = {
