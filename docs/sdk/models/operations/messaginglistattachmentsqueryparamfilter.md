...
```typescript
import { MessagingListAttachmentsQueryParamFilter } from "@stackone/stackone-client-ts/sdk/models/operations";

let value: MessagingListAttachmentsQueryParamFilter = {
