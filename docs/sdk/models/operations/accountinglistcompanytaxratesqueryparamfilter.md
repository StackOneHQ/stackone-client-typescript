...
```typescript
import { AccountingListCompanyTaxRatesQueryParamFilter } from "@stackone/stackone-client-ts/sdk/models/operations";

let value: AccountingListCompanyTaxRatesQueryParamFilter = {
