...
```typescript
import { AccountingListCompanyJournalsQueryParamFilter } from "@stackone/stackone-client-ts/sdk/models/operations";

let value: AccountingListCompanyJournalsQueryParamFilter = {
