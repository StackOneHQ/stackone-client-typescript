...
```typescript
import { CustomFields } from "@stackone/stackone-client-ts/sdk/models/shared";
...
| `value`                                                         | *shared.CustomFieldsValue*                                      | :heavy_minus_sign:                                              | The value associated with the custom field.                     | Completed                                                       |
