...
```typescript
import { AtsCreateBackgroundCheckOrderRequestDtoRequester } from "@stackone/stackone-client-ts/sdk/models/shared";

let value: AtsCreateBackgroundCheckOrderRequestDtoRequester = {
