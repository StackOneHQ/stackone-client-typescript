...
```typescript
import { AtsCreateBackgroundCheckOrderRequestDtoPackage } from "@stackone/stackone-client-ts/sdk/models/shared";

let value: AtsCreateBackgroundCheckOrderRequestDtoPackage = {
  description:
