...
```typescript
import { IamGroupValue, IamMfaTypeEnumValue, IamRoleValue, IamUser, IamUserValue } from "@stackone/stackone-client-ts/sdk/models/shared";
...
| `isBotUser`                                                                                    | *shared.IamUserIsBotUser*                                                                      | :heavy_minus_sign:                                                                             | Indicates if the user is a bot or service user                                                 | true                                                                                           |
