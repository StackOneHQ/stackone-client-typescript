...
```typescript
import { AtsCreateCandidatesAssessmentsRequestDtoRequester } from "@stackone/stackone-client-ts/sdk/models/shared";

let value: AtsCreateCandidatesAssessmentsRequestDtoRequester = {
