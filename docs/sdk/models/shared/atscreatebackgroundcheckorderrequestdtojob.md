...
```typescript
import { AtsCreateBackgroundCheckOrderRequestDtoJob } from "@stackone/stackone-client-ts/sdk/models/shared";

let value: AtsCreateBackgroundCheckOrderRequestDtoJob = {
  hiringTeam: [
    {
