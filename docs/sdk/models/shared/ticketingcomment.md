...
```typescript
import { TicketingComment } from "@stackone/stackone-client-ts/sdk/models/shared";

let value: TicketingComment = {
  content: [
    {
...
| `internal`                                                                                    | *shared.TicketingCommentInternal*                                                             | :heavy_minus_sign:                                                                            | Whether the comment is internal                                                               | false                                                                                         |
