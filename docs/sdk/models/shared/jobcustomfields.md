...
```typescript
import { JobCustomFields } from "@stackone/stackone-client-ts/sdk/models/shared";

let value: JobCustomFields = {
...
| `value`                                                         | *shared.JobCustomFieldsValue*                                   | :heavy_minus_sign:                                              | The value associated with the custom field.                     | Completed                                                       |
