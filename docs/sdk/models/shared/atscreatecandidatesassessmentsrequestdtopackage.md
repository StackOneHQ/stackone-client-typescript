...
```typescript
import { AtsCreateCandidatesAssessmentsRequestDtoPackage } from "@stackone/stackone-client-ts/sdk/models/shared";

let value: AtsCreateCandidatesAssessmentsRequestDtoPackage = {
  description:
