 ...
 */
export async function hrisGetEmployeeCustomFieldDefinition(
  client: StackOneCore,
  request: operations.HrisGetEmployeeCustomFieldDefinitionRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.HrisGetEmployeeCustomFieldDefinitionResponse,
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisGetEmployeeCustomFieldDefinitionRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.HrisGetEmployeeCustomFieldDefinitionResponse$inboundSchema,
