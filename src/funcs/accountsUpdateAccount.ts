 ...
 * Update Account
 */
export async function accountsUpdateAccount(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.StackoneUpdateAccountRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.PatchAccountExternalDto, {
    explode: true,
  });
