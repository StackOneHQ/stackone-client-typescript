...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.TicketingListAttachmentsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/ticketing/tickets/{id}/attachments")(
    pathParams,
  );
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TicketingListAttachmentsResponse$inboundSchema, {
      key: "TicketingAttachmentsPaginated",
    }),
