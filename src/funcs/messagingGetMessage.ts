 ...
 * Get Message
 */
export function messagingGetMessage(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.MessagingGetMessageRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/messaging/messages/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.MessagingGetMessageResponse$inboundSchema, {
      key: "MessagingMessageResult",
    }),
