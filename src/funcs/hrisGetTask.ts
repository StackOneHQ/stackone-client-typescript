 ...
 * Get Task
 */
export function hrisGetTask(
  client: StackOneCore,
  request: operations.HrisGetTaskRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.HrisGetTaskResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.HrisGetTaskRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/hris/tasks/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.HrisGetTaskResponse$inboundSchema, {
      key: "TaskResult",
    }),
