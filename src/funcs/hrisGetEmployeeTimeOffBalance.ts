 ...
 */
export async function hrisGetEmployeeTimeOffBalance(
  client: StackOneCore,
  request: operations.HrisGetEmployeeTimeOffBalanceRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.HrisGetEmployeeTimeOffBalanceResponse,
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisGetEmployeeTimeOffBalanceRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.HrisGetEmployeeTimeOffBalanceResponse$inboundSchema,
      { key: "TimeOffBalanceResult" },
    ),
    M.fail(408),
