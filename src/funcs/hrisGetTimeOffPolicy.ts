...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisGetTimeOffPolicyRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/hris/time_off_policies/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.HrisGetTimeOffPolicyResponse$inboundSchema, {
      key: "TimeOffPolicyResult",
    }),
