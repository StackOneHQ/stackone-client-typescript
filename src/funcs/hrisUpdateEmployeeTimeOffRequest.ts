 ...
 */
export function hrisUpdateEmployeeTimeOffRequest(
  client: StackOneCore,
  request: operations.HrisUpdateEmployeeTimeOffRequestRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.HrisUpdateEmployeeTimeOffRequestResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisUpdateEmployeeTimeOffRequestRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.HrisUpdateEmployeeTimeOffRequestResponse$inboundSchema,
      { key: "CreateResult" },
    ),
