...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisListEmployeeWorkEligibilityRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/unified/hris/employees/{id}/work_eligibility")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      operations.HrisListEmployeeWorkEligibilityResponse$inboundSchema,
