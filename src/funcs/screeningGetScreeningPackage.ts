 ...
 */
export function screeningGetScreeningPackage(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ScreeningGetScreeningPackageRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ScreeningGetScreeningPackageResponse$inboundSchema, {
      key: "ScreeningPackageResult",
    }),
