 ...
 * List Positions
 */
export function hrisListPositions(
  client: StackOneCore,
  ...
  PageIterator<
    Result<
      operations.HrisListPositionsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.HrisListPositionsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/hris/positions")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.HrisListPositionsResponse$inboundSchema, {
      key: "PositionsPaginated",
    }),
