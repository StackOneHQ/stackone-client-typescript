 ...
 * Get User
 */
export function messagingGetUser(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.MessagingGetUserRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/messaging/users/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.MessagingGetUserResponse$inboundSchema, {
      key: "MessagingUserResult",
    }),
