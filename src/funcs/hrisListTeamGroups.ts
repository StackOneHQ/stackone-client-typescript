 ...
 * List Team Groups
 */
export async function hrisListTeamGroups(
  client: StackOneCore,
  request: operations.HrisListTeamGroupsRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.HrisListTeamGroupsResponse,
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.HrisListTeamGroupsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/hris/groups/teams")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.HrisListTeamGroupsResponse$inboundSchema, {
      key: "HRISTeamsPaginated",
    }),
    M.fail(408),
