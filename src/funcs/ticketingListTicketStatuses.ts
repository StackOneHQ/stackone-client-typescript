...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.TicketingListTicketStatusesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/ticketing/tickets/{id}/statuses")(
    pathParams,
  );
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.TicketingListTicketStatusesResponse$inboundSchema, {
      key: "TicketingTicketStatusesPaginated",
    }),
