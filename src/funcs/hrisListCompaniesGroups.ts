 ...
 */
export function hrisListCompaniesGroups(
  client: StackOneCore,
  ...
  PageIterator<
    Result<
      operations.HrisListCompaniesGroupsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisListCompaniesGroupsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/hris/groups/companies")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.HrisListCompaniesGroupsResponse$inboundSchema, {
