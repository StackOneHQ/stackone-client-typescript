 ...
 * Delete Content
 */
export async function lmsDeleteContent(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.LmsDeleteContentRequest$outboundSchema.parse(value),
  ...
  const context = {
    operationID: "lms_delete_content",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.LmsDeleteContentResponse$inboundSchema, {
      key: "DeleteResult",
    }),
