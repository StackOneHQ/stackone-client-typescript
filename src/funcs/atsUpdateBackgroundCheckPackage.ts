 ...
 */
export function atsUpdateBackgroundCheckPackage(
  client: StackOneCore,
  request: operations.AtsUpdateBackgroundCheckPackageRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AtsUpdateBackgroundCheckPackageResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AtsUpdateBackgroundCheckPackageRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON(
    "body",
    payload.AtsUpdateBackgroundCheckPackagesRequestDto,
    { explode: true },
  );
  ...
  >(
    M.json(
      200,
      operations.AtsUpdateBackgroundCheckPackageResponse$inboundSchema,
      { key: "UpdateResult" },
    ),
