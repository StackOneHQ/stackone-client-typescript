...
export function ticketingListUsers(
  ...
  PageIterator<
    Result<
      operations.TicketingListUsersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.TicketingListUsersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/ticketing/users")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TicketingListUsersResponse$inboundSchema, {
      key: "TicketingUsersPaginated",
    }),
