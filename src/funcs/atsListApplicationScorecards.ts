 ...
 */
export async function atsListApplicationScorecards(
  client$: StackOneCore,
...
> {
  ...
  const path$ = pathToFunc("/unified/ats/applications/{id}/scorecards")(
    pathParams$,
  );
  ...
  >(
    m$.json(
      200,
      operations.AtsListApplicationScorecardsResponse$inboundSchema,
