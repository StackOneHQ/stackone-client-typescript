 ...
 * Get Skill
 */
export async function lmsGetSkill(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.LmsGetSkillRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/lms/skills/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.LmsGetSkillResponse$inboundSchema, {
      key: "SkillResult",
    }),
