 ...
 * List Skills
 */
export async function lmsListSkills(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.LmsListSkillsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/lms/skills")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.LmsListSkillsResponse$inboundSchema, {
      key: "SkillsPaginated",
    }),
