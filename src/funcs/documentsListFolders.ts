 ...
 * List Folders
 */
export function documentsListFolders(
  client: StackOneCore,
  ...
  PageIterator<
    Result<
      operations.DocumentsListFoldersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DocumentsListFoldersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/documents/folders")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DocumentsListFoldersResponse$inboundSchema, {
      key: "FoldersPaginated",
    }),
