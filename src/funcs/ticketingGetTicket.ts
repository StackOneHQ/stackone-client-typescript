...
export function ticketingGetTicket(
  ...
  Result<
    operations.TicketingGetTicketResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.TicketingGetTicketRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TicketingGetTicketResponse$inboundSchema, {
      key: "TicketingTicketResult",
    }),
