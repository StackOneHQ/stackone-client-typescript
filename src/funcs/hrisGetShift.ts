 ...
 * Get Shift
 */
export function hrisGetShift(
  client: StackOneCore,
  request: operations.HrisGetShiftRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.HrisGetShiftResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.HrisGetShiftRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/hris/shifts/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.HrisGetShiftResponse$inboundSchema, {
      key: "HrisShiftResult",
    }),
