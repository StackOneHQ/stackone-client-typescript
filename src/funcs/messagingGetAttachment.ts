 ...
 * Get Attachment
 */
export function messagingGetAttachment(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.MessagingGetAttachmentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.MessagingGetAttachmentResponse$inboundSchema, {
      key: "MessagingAttachmentResult",
    }),
