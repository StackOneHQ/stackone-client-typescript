 ...
 */
export async function atsListApplicationNotes(
  client: StackOneCore,
  ...
  PageIterator<
    Result<
      operations.AtsListApplicationNotesResponse,
      | SDKError
      | SDKValidationError
      | UnexpectedClientError
      | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AtsListApplicationNotesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/ats/applications/{id}/notes")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AtsListApplicationNotesResponse$inboundSchema, {
      key: "NotesPaginated",
    }),
    M.fail(408),
