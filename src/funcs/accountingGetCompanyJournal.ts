 ...
 * Get Journal
 */
export function accountingGetCompanyJournal(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AccountingGetCompanyJournalRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AccountingGetCompanyJournalResponse$inboundSchema, {
      key: "AccountingJournalResult",
    }),
