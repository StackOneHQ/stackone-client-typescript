 ...
 */
export async function atsGetAssessmentsPackage(
  client$: StackOneCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.AtsGetAssessmentsPackageRequest$outboundSchema.parse(value$),
  ...
  const path$ = pathToFunc("/unified/ats/assessments/packages/{id}")(
    pathParams$,
  );
