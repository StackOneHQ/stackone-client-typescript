 ...
 */
export async function atsListApplicationCustomFieldDefinitions(
    client$: StackOneCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) =>
            operations.AtsListApplicationCustomFieldDefinitionsRequest$outboundSchema.parse(value$),
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.AtsListApplicationCustomFieldDefinitionsResponse$inboundSchema, {
