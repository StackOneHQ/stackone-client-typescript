...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) =>
            operations.HrisCreateEmployeeWorkEligibilityRequestRequest$outboundSchema.parse(value$),
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(201, operations.HrisCreateEmployeeWorkEligibilityRequestResponse$inboundSchema, {
            key: "CreateResult",
        }),
