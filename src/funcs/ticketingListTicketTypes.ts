...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.TicketingListTicketTypesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/ticketing/ticket_types")();
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.TicketingListTicketTypesResponse$inboundSchema, {
