 ...
 * Get Division Group
 */
export function hrisGetDivisionGroup(
  client: StackOneCore,
  request: operations.HrisGetDivisionGroupRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.HrisGetDivisionGroupResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisGetDivisionGroupRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/hris/groups/divisions/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.HrisGetDivisionGroupResponse$inboundSchema, {
      key: "HRISDivisionsResult",
    }),
