 ...
 */
export async function atsGetBackgroundCheckResult(
  client: StackOneCore,
  request: operations.AtsGetBackgroundCheckResultRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.AtsGetBackgroundCheckResultResponse,
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AtsGetBackgroundCheckResultRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AtsGetBackgroundCheckResultResponse$inboundSchema, {
      key: "BackgroundCheckResultsResult",
    }),
    M.fail(408),
