 ...
 */
export async function atsListApplicationDocuments(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AtsListApplicationDocumentsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/ats/applications/{id}/documents")(
    pathParams,
  );
