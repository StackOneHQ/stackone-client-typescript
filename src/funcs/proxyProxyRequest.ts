 ...
 * Proxy Request
 */
export async function proxyProxyRequest(
  client$: StackOneCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.StackoneProxyRequestRequest$outboundSchema.parse(value$),
  ...
  const body$ = encodeJSON$("body", payload$.ProxyRequestBody, {
    explode: true,
  });
