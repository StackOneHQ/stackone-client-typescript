 ...
 */
export async function hrisBatchUploadEmployeeDocument(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisBatchUploadEmployeeDocumentRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload.HrisBatchDocumentUploadRequestDto, {
    explode: true,
  });
  ...
  >(
    M.json(
      202,
      operations.HrisBatchUploadEmployeeDocumentResponse$inboundSchema,
