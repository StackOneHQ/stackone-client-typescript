...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.HrisGetEmployeesTimeOffRequestRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/unified/hris/employees/{id}/time_off/{subResourceId}")(pathParams$);
