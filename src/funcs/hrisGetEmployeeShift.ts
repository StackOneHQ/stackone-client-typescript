 ...
 * Get Employee Shift
 */
export function hrisGetEmployeeShift(
  client: StackOneCore,
  request: operations.HrisGetEmployeeShiftRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.HrisGetEmployeeShiftResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisGetEmployeeShiftRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.HrisGetEmployeeShiftResponse$inboundSchema, {
      key: "HrisShiftResult",
    }),
