 ...
 */
export async function lmsCreateCompletion(
    client$: StackOneCore,
...
> {
    ...
    const body$ = encodeJSON$("body", payload$.LmsCreateCompletionRequestDto, { explode: true });
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(201, operations.LmsCreateCompletionResponse$inboundSchema, { key: "CreateResult" }),
