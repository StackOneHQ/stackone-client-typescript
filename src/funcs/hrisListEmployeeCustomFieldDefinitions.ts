 ...
 */
export async function hrisListEmployeeCustomFieldDefinitions(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisListEmployeeCustomFieldDefinitionsRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/unified/hris/custom_field_definitions/employees")();
  ...
  >(
    M.json(
      200,
      operations.HrisListEmployeeCustomFieldDefinitionsResponse$inboundSchema,
