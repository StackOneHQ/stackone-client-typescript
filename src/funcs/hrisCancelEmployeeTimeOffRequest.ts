 ...
 */
export function hrisCancelEmployeeTimeOffRequest(
  client: StackOneCore,
  request: operations.HrisCancelEmployeeTimeOffRequestRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.HrisCancelEmployeeTimeOffRequestResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisCancelEmployeeTimeOffRequestRequest$outboundSchema.parse(
        value,
      ),
