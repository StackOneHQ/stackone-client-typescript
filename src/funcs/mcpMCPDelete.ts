...
> {
  const parsed = safeParse(
    request,
    (value) => operations.StackoneMcpDeleteRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(200, operations.StackoneMcpDeleteResponse$inboundSchema),
