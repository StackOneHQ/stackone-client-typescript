 ...
 */
export async function hrisGetEmployeeEmployment(
    client$: StackOneCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.HrisGetEmployeeEmploymentRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/unified/hris/employees/{id}/employments/{subResourceId}")(
        pathParams$
    );
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.HrisGetEmployeeEmploymentResponse$inboundSchema, {
