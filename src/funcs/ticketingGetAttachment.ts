...
export function ticketingGetAttachment(
  ...
  Result<
    operations.TicketingGetAttachmentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.TicketingGetAttachmentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TicketingGetAttachmentResponse$inboundSchema, {
      key: "TicketingAttachmentResult",
    }),
