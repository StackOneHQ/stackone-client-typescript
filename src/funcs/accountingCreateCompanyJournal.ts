 ...
 * Create Journal
 */
export function accountingCreateCompanyJournal(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AccountingCreateCompanyJournalRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload.AccountingJournalCreateRequestDto, {
    explode: true,
  });
