 ...
 * List Courses
 */
export async function lmsListCourses(
    client$: StackOneCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.LmsListCoursesRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/unified/lms/courses")();
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.LmsListCoursesResponse$inboundSchema, { key: "CoursePaginated" }),
