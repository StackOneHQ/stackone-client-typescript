 ...
 */
export async function atsGetJobCustomFieldDefinition(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AtsGetJobCustomFieldDefinitionRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.AtsGetJobCustomFieldDefinitionResponse$inboundSchema,
