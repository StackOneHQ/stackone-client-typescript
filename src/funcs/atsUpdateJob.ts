 ...
 * Update Job
 */
export async function atsUpdateJob(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AtsUpdateJobRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.AtsUpdateJobRequestDto, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AtsUpdateJobResponse$inboundSchema, {
      key: "CreateResult",
    }),
