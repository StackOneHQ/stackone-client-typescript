 ...
 */
export function actionsSearchActions(
  client: StackOneCore,
  request: shared.ActionSearchDto,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.StackoneSearchActionsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => shared.ActionSearchDto$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/actions/search")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.StackoneSearchActionsResponse$inboundSchema, {
      key: "ActionSearchResponseDto",
    }),
