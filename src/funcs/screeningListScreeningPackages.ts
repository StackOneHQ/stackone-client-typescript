 ...
 */
export function screeningListScreeningPackages(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ScreeningListScreeningPackagesRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/unified/screening/packages")();
  ...
  >(
    M.json(
      200,
      operations.ScreeningListScreeningPackagesResponse$inboundSchema,
      { key: "ScreeningPackagesPaginated" },
    ),
