 ...
 */
export async function lmsCreateUserCompletion(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.LmsCreateUserCompletionRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, operations.LmsCreateUserCompletionResponse$inboundSchema, {
      key: "CreateResult",
    }),
