 ...
 */
export async function atsGetBackgroundCheckPackage(
  client: StackOneCore,
  request: operations.AtsGetBackgroundCheckPackageRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.AtsGetBackgroundCheckPackageResponse,
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AtsGetBackgroundCheckPackageRequest$outboundSchema.parse(
        value,
      ),
