...
export function ticketingGetComment(
  ...
  Result<
    operations.TicketingGetCommentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.TicketingGetCommentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TicketingGetCommentResponse$inboundSchema, {
      key: "TicketingCommentResult",
    }),
