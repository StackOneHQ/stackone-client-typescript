 ...
 * List Drives
 */
export function documentsListDrives(
  client: StackOneCore,
  ...
  PageIterator<
    Result<
      operations.DocumentsListDrivesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DocumentsListDrivesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/documents/drives")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DocumentsListDrivesResponse$inboundSchema, {
      key: "DrivesPaginated",
    }),
