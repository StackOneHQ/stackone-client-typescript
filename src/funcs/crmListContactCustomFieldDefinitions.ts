 ...
 */
export async function crmListContactCustomFieldDefinitions(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CrmListContactCustomFieldDefinitionsRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/unified/crm/custom_field_definitions/contacts")();
  ...
  >(
    M.json(
      200,
      operations.CrmListContactCustomFieldDefinitionsResponse$inboundSchema,
