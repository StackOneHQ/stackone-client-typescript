 ...
 */
export async function atsGetCandidateCustomFieldDefinition(
    client$: StackOneCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) =>
            operations.AtsGetCandidateCustomFieldDefinitionRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/unified/ats/custom_field_definitions/candidates/{id}")(pathParams$);
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.AtsGetCandidateCustomFieldDefinitionResponse$inboundSchema, {
