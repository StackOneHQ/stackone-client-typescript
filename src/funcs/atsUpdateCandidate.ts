 ...
 * Update Candidate
 */
export async function atsUpdateCandidate(
  client$: StackOneCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.AtsUpdateCandidateRequest$outboundSchema.parse(value$),
  ...
  const body$ = encodeJSON$("body", payload$.AtsUpdateCandidateRequestDto, {
    explode: true,
  });
