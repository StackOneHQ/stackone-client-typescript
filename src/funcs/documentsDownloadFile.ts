 ...
 * Download File
 */
export function documentsDownloadFile(
  client: StackOneCore,
  request: operations.DocumentsDownloadFileRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DocumentsDownloadFileResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DocumentsDownloadFileRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/documents/files/{id}/download")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.bytes(200, operations.DocumentsDownloadFileResponse$inboundSchema, {
      ctype: "*/*",
      key: "Body",
    }),
