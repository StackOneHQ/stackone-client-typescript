 ...
 * Get Employee Task
 */
export function hrisGetEmployeeTask(
  client: StackOneCore,
  request: operations.HrisGetEmployeeTaskRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.HrisGetEmployeeTaskResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisGetEmployeeTaskRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.HrisGetEmployeeTaskResponse$inboundSchema, {
      key: "TaskResult",
    }),
