 ...
 * List Companies
 */
export function accountingListCompanies(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AccountingListCompaniesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/accounting/companies")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AccountingListCompaniesResponse$inboundSchema, {
      key: "AccountingCompaniesPaginated",
    }),
