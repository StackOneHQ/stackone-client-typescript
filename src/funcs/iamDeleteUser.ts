...
> {
  const parsed = safeParse(
    request,
    (value) => operations.IamDeleteUserRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.IamDeleteUserResponse$inboundSchema, {
      key: "DeleteResult",
    }),
    M.nil(204, operations.IamDeleteUserResponse$inboundSchema),
