 ...
 */
export function atsListJobApplicationStages(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AtsListJobApplicationStagesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/ats/jobs/{id}/application_stages")(
    pathParams,
  );
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AtsListJobApplicationStagesResponse$inboundSchema, {
      key: "ApplicationStagesPaginated",
    }),
