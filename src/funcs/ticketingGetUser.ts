...
export function ticketingGetUser(
  ...
  Result<
    operations.TicketingGetUserResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.TicketingGetUserRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TicketingGetUserResponse$inboundSchema, {
      key: "TicketingUserResult",
    }),
