 ...
 * Create Candidate
 */
export async function atsCreateCandidate(
  client$: StackOneCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.AtsCreateCandidateRequest$outboundSchema.parse(value$),
  ...
  const body$ = encodeJSON$("body", payload$.AtsCreateCandidateRequestDto, {
    explode: true,
  });
