 ...
 * List Step Logs
 */
export function requestLogsListStepLogs(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.StackoneListStepLogsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/requests/logs/steps")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.StackoneListStepLogsResponse$inboundSchema, {
      key: "StepLogsPaginated",
    }),
