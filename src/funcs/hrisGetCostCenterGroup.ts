 ...
 */
export async function hrisGetCostCenterGroup(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisGetCostCenterGroupRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/hris/groups/cost_centers/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.HrisGetCostCenterGroupResponse$inboundSchema, {
      key: "HRISCostCenterResult",
    }),
