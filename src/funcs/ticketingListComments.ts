...
export function ticketingListComments(
  ...
  PageIterator<
    Result<
      operations.TicketingListCommentsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.TicketingListCommentsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/ticketing/tickets/{id}/comments")(
    pathParams,
  );
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TicketingListCommentsResponse$inboundSchema, {
      key: "TicketingCommentsPaginated",
    }),
