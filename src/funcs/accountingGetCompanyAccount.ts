 ...
 * Get Account
 */
export function accountingGetCompanyAccount(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AccountingGetCompanyAccountRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AccountingGetCompanyAccountResponse$inboundSchema, {
      key: "AccountingAccountResult",
    }),
