 ...
 * Get a Log
 */
export function requestLogsGetLog(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.StackoneGetLogRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/requests/logs/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.StackoneGetLogResponse$inboundSchema, {
      key: "UnifiedLogResult",
    }),
