 ...
 */
export function atsListApplicationStages(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AtsListApplicationStagesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/ats/application_stages")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AtsListApplicationStagesResponse$inboundSchema, {
