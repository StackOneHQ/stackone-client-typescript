 ...
 */
export function actionsBuildActionEmbeddings(
  client: StackOneCore,
  request: shared.ActionBuildDto,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.StackoneBuildActionEmbeddingsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => shared.ActionBuildDto$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/actions/build")();
  ...
  >(
    M.json(
      200,
      operations.StackoneBuildActionEmbeddingsResponse$inboundSchema,
      { key: "ActionBuildResponseDto" },
    ),
