 ...
 */
export async function hrisListCostCenterGroups(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisListCostCenterGroupsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/hris/groups/cost_centers")();
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.HrisListCostCenterGroupsResponse$inboundSchema, {
      key: "HRISCostCenterPaginated",
    }),
    M.fail(408),
