 ...
 */
export async function atsUpdateApplicationNote(
  client: StackOneCore,
  request: operations.AtsUpdateApplicationNoteRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.AtsUpdateApplicationNoteResponse,
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AtsUpdateApplicationNoteRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AtsUpdateApplicationNoteResponse$inboundSchema, {
      key: "UpdateResult",
    }),
    M.fail(408),
