 ...
 * Get Position
 */
export function hrisGetPosition(
  client: StackOneCore,
  request: operations.HrisGetPositionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.HrisGetPositionResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.HrisGetPositionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/hris/positions/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.HrisGetPositionResponse$inboundSchema, {
      key: "PositionResult",
    }),
