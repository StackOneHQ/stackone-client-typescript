 ...
 */
export function ticketingListProjectTicketTypes(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.TicketingListProjectTicketTypesRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/unified/ticketing/projects/{id}/ticket_types")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      operations.TicketingListProjectTicketTypesResponse$inboundSchema,
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      ticketingListProjectTicketTypes(
        client,
        {
          ...request,
          next: nextCursor,
