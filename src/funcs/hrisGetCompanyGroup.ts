 ...
 * Get Company Group
 */
export function hrisGetCompanyGroup(
  client: StackOneCore,
  request: operations.HrisGetCompanyGroupRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.HrisGetCompanyGroupResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisGetCompanyGroupRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/hris/groups/companies/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.HrisGetCompanyGroupResponse$inboundSchema, {
      key: "CompanyResult",
    }),
