 ...
 * Create Job
 */
export async function atsCreateJob(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AtsCreateJobRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.AtsCreateJobRequestDto, {
    explode: true,
  });
