...
export function ticketingCreateTicket(
  ...
  Result<
    operations.TicketingCreateTicketResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.TicketingCreateTicketRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.TicketingTicketCreateRequestDto, {
    explode: true,
  });

  const path = pathToFunc("/unified/ticketing/tickets")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, operations.TicketingCreateTicketResponse$inboundSchema, {
      key: "CreateResult",
    }),
