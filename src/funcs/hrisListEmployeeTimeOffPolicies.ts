 ...
 */
export function hrisListEmployeeTimeOffPolicies(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisListEmployeeTimeOffPoliciesRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/unified/hris/employees/{id}/time_off_policies")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      operations.HrisListEmployeeTimeOffPoliciesResponse$inboundSchema,
