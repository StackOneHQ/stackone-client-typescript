 ...
 */
export async function atsListBackgroundCheckRequest(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AtsListBackgroundCheckRequestRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.AtsListBackgroundCheckRequestResponse$inboundSchema,
      { key: "BackgroundCheckOrderPaginated" },
    ),
