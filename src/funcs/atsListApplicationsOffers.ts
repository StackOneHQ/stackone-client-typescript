 ...
 */
export async function atsListApplicationsOffers(
  client$: StackOneCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.AtsListApplicationsOffersRequest$outboundSchema.parse(value$),
  ...
  const path$ = pathToFunc("/unified/ats/applications/{id}/offers")(
    pathParams$,
  );
