 ...
 */
export async function atsGetApplicationNote(
  client: StackOneCore,
  request: operations.AtsGetApplicationNoteRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.AtsGetApplicationNoteResponse,
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AtsGetApplicationNoteRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.AtsGetApplicationNoteResponse$inboundSchema, {
      key: "NoteResult",
    }),
    M.fail(408),
