 ...
 * Get Company
 */
export function accountingGetCompany(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AccountingGetCompanyRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/accounting/companies/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AccountingGetCompanyResponse$inboundSchema, {
      key: "AccountingCompanyResult",
    }),
