 ...
 * List Users
 */
export function messagingListUsers(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.MessagingListUsersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/messaging/users")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.MessagingListUsersResponse$inboundSchema, {
      key: "MessagingUsersPaginated",
    }),
