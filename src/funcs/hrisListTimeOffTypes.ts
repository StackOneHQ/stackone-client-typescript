 ...
 * List time off types
 */
export async function hrisListTimeOffTypes(
  client: StackOneCore,
  ...
  PageIterator<
    Result<
      operations.HrisListTimeOffTypesResponse,
      | SDKError
      | SDKValidationError
      | UnexpectedClientError
      | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisListTimeOffTypesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/hris/time_off_types")();
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.HrisListTimeOffTypesResponse$inboundSchema, {
