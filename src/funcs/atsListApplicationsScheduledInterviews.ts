 ...
 */
export async function atsListApplicationsScheduledInterviews(
    client$: StackOneCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) =>
            operations.AtsListApplicationsScheduledInterviewsRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/unified/ats/applications/{id}/scheduled_interviews")(pathParams$);
