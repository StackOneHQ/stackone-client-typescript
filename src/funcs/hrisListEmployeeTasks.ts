 ...
 * List Employee Tasks
 */
export function hrisListEmployeeTasks(
  client: StackOneCore,
  ...
  PageIterator<
    Result<
      operations.HrisListEmployeeTasksResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisListEmployeeTasksRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/hris/employees/{id}/tasks")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.HrisListEmployeeTasksResponse$inboundSchema, {
      key: "TasksPaginated",
    }),
