 ...
 */
export function hrisListEmployeeShifts(
  client: StackOneCore,
  ...
  PageIterator<
    Result<
      operations.HrisListEmployeeShiftsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisListEmployeeShiftsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/hris/employees/{id}/shifts")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.HrisListEmployeeShiftsResponse$inboundSchema, {
      key: "HrisShiftsPaginated",
    }),
