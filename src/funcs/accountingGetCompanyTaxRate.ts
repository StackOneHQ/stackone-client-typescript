 ...
 * Get Tax Rate
 */
export function accountingGetCompanyTaxRate(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AccountingGetCompanyTaxRateRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AccountingGetCompanyTaxRateResponse$inboundSchema, {
      key: "AccountingTaxRateResult",
    }),
