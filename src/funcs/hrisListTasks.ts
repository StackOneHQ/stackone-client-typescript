...
export function hrisListTasks(
  ...
  PageIterator<
    Result<
      operations.HrisListTasksResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.HrisListTasksRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/hris/tasks")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.HrisListTasksResponse$inboundSchema, {
      key: "TasksPaginated",
    }),
