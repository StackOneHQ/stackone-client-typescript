 ...
 */
export async function atsListJobCustomFieldDefinitions(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AtsListJobCustomFieldDefinitionsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/unified/ats/custom_field_definitions/jobs")();
  ...
  >(
    M.json(
      200,
      operations.AtsListJobCustomFieldDefinitionsResponse$inboundSchema,
