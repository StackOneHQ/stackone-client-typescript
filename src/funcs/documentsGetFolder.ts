 ...
 * Get Folder
 */
export function documentsGetFolder(
  client: StackOneCore,
  request: operations.DocumentsGetFolderRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DocumentsGetFolderResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DocumentsGetFolderRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/documents/folders/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DocumentsGetFolderResponse$inboundSchema, {
      key: "FolderResult",
    }),
