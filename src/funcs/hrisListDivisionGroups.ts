 ...
 */
export function hrisListDivisionGroups(
  client: StackOneCore,
  ...
  PageIterator<
    Result<
      operations.HrisListDivisionGroupsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisListDivisionGroupsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/hris/groups/divisions")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.HrisListDivisionGroupsResponse$inboundSchema, {
      key: "HRISDivisionsPaginated",
    }),
