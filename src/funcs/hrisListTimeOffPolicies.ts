 ...
 */
export async function hrisListTimeOffPolicies(
  client: StackOneCore,
  ...
  PageIterator<
    Result<
      operations.HrisListTimeOffPoliciesResponse,
      | SDKError
      | SDKValidationError
      | UnexpectedClientError
      | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisListTimeOffPoliciesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/hris/time_off_policies")();
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.HrisListTimeOffPoliciesResponse$inboundSchema, {
      key: "TimeOffPoliciesPaginated",
    }),
    M.fail(408),
