 ...
 */
export function accountingBatchCreateCompanyJournals(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AccountingBatchCreateCompanyJournalsRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload.AccountingJournalBatchCreateRequestDto,
    { explode: true },
  );
  ...
  const path = pathToFunc("/unified/accounting/companies/{id}/journals/batch")(
    pathParams,
  );
  ...
  >(
    M.json(
      202,
      operations.AccountingBatchCreateCompanyJournalsResponse$inboundSchema,
