...
export function ticketingGetTicketType(
  ...
  Result<
    operations.TicketingGetTicketTypeResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.TicketingGetTicketTypeRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/ticketing/ticket_types/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.TicketingGetTicketTypeResponse$inboundSchema, {
      key: "TicketingTicketTypeResult",
    }),
