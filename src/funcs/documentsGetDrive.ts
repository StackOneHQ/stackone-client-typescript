 ...
 * Get Drive
 */
export function documentsGetDrive(
  client: StackOneCore,
  request: operations.DocumentsGetDriveRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DocumentsGetDriveResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DocumentsGetDriveRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/documents/drives/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DocumentsGetDriveResponse$inboundSchema, {
      key: "DriveResult",
    }),
