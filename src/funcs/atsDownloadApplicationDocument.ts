...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.AtsDownloadApplicationDocumentRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/unified/ats/applications/{id}/documents/{subResourceId}/download")(
        pathParams$
    );
