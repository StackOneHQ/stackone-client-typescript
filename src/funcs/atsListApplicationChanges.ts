 ...
 */
export function atsListApplicationChanges(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AtsListApplicationChangesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/ats/applications/{id}/changes")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AtsListApplicationChangesResponse$inboundSchema, {
      key: "ApplicationChangesPaginated",
    }),
