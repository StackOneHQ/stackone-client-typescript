 ...
 * List Accounts
 */
export function accountingListCompanyAccounts(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AccountingListCompanyAccountsRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.AccountingListCompanyAccountsResponse$inboundSchema,
      { key: "AccountingAccountsPaginated" },
    ),
