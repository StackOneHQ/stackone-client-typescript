 ...
 * List Conversations
 */
export function messagingListConversations(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.MessagingListConversationsRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.MessagingListConversationsResponse$inboundSchema, {
      key: "MessagingConversationsPaginated",
    }),
