 ...
 */
export function atsGetJobApplicationStage(
  client: StackOneCore,
  request: operations.AtsGetJobApplicationStageRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AtsGetJobApplicationStageResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AtsGetJobApplicationStageRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AtsGetJobApplicationStageResponse$inboundSchema, {
      key: "ApplicationStageResult",
    }),
