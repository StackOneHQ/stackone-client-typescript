 ...
 * Get User Assignment
 */
export async function lmsGetAssignment(
    client$: StackOneCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.LmsGetAssignmentRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/unified/lms/users/{id}/assignments/{subResourceId}")(pathParams$);
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.LmsGetAssignmentResponse$inboundSchema, {
