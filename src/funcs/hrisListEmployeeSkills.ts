 ...
 */
export function hrisListEmployeeSkills(
  client: StackOneCore,
  ...
  PageIterator<
    Result<
      operations.HrisListEmployeeSkillsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.HrisListEmployeeSkillsRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.HrisListEmployeeSkillsResponse$inboundSchema, {
      key: "EntitySkillsPaginated",
    }),
