 ...
 */
export async function crmGetContactCustomFieldDefinition(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CrmGetContactCustomFieldDefinitionRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.CrmGetContactCustomFieldDefinitionResponse$inboundSchema,
