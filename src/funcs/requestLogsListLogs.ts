 ...
 * List Logs
 */
export function requestLogsListLogs(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.StackoneListLogsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/requests/logs")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.StackoneListLogsResponse$inboundSchema, {
      key: "UnifiedLogsPaginated",
    }),
