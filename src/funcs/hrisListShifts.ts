 ...
 * List Shifts
 */
export function hrisListShifts(
  client: StackOneCore,
  ...
  PageIterator<
    Result<
      operations.HrisListShiftsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.HrisListShiftsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/hris/shifts")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.HrisListShiftsResponse$inboundSchema, {
