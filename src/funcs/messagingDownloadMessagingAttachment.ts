 ...
 * Download Attachment
 */
export function messagingDownloadMessagingAttachment(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.MessagingDownloadMessagingAttachmentRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.stream(
      200,
      operations.MessagingDownloadMessagingAttachmentResponse$inboundSchema,
