...
export function documentsUploadFile(
  ...
  Result<
    operations.DocumentsUploadFileResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DocumentsUploadFileRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/documents/files/upload")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.DocumentsUploadFileResponse$inboundSchema, {
