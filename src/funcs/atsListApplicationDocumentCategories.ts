 ...
 */
export function atsListApplicationDocumentCategories(
  client: StackOneCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AtsListApplicationDocumentCategoriesRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/unified/ats/documents/application_categories")();
  ...
  >(
    M.json(
      200,
      operations.AtsListApplicationDocumentCategoriesResponse$inboundSchema,
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      atsListApplicationDocumentCategories(
        client,
        {
          ...request,
          next: nextCursor,
