 ...
 * Get Team Group
 */
export async function hrisGetTeamGroup(
  client: StackOneCore,
  request: operations.HrisGetTeamGroupRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.HrisGetTeamGroupResponse,
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.HrisGetTeamGroupRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/hris/groups/teams/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.HrisGetTeamGroupResponse$inboundSchema, {
      key: "HRISTeamsResult",
    }),
    M.fail(408),
