...
export function ticketingUpdateTicket(
  ...
  Result<
    operations.TicketingUpdateTicketResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.TicketingUpdateTicketRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.TicketingTicketUpdateRequestDto, {
    explode: true,
  });
  ...
  const path = pathToFunc("/unified/ticketing/tickets/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TicketingUpdateTicketResponse$inboundSchema, {
      key: "UpdateResult",
    }),
