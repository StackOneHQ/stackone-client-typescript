...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) =>
            operations.AtsGetApplicationCustomFieldDefinitionRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/unified/ats/custom_field_definitions/applications/{id}")(
        pathParams$
    );
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.AtsGetApplicationCustomFieldDefinitionResponse$inboundSchema, {
