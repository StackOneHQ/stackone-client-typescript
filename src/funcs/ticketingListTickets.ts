...
export function ticketingListTickets(
  ...
  PageIterator<
    Result<
      operations.TicketingListTicketsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.TicketingListTicketsRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.TicketingListTicketsResponse$inboundSchema, {
      key: "TicketingTicketsPaginated",
    }),
