 ...
 */
export function atsGetApplicationStage(
  client: StackOneCore,
  request: operations.AtsGetApplicationStageRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.AtsGetApplicationStageResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AtsGetApplicationStageRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/ats/application_stages/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AtsGetApplicationStageResponse$inboundSchema, {
