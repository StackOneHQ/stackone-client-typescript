 ...
 */
export function ticketingListProjects(
  client: StackOneCore,
  ...
  PageIterator<
    Result<
      operations.TicketingListProjectsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.TicketingListProjectsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/unified/ticketing/projects")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TicketingListProjectsResponse$inboundSchema, {
      key: "TicketingProjectsPaginated",
    }),
