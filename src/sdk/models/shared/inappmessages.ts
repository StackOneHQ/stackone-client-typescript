...
/** @internal */
export const InAppMessages4$inboundSchema: z.ZodType<InAppMessages4, z.ZodTypeDef, unknown> =
    z.object({});
...
/** @internal */
export const InAppMessages$inboundSchema: z.ZodType<InAppMessages, z.ZodTypeDef, unknown> = z
    .object({
        id: z.nullable(z.string()).optional(),
        message_content: z
            .nullable(z.lazy(() => InAppMessagesMessageContent$inboundSchema))
            .optional(),
        message_type: z.nullable(z.lazy(() => InAppMessagesMessageType$inboundSchema)).optional(),
...
> = z
    .object({
        id: z.nullable(z.string()).optional(),
        messageContent: z
            .nullable(z.lazy(() => InAppMessagesMessageContent$outboundSchema))
            .optional(),
        messageType: z.nullable(z.lazy(() => InAppMessagesMessageType$outboundSchema)).optional(),
        name: z.nullable(z.string()).optional(),
