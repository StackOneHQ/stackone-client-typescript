...
export type CourseSourceValue = Course4 | string | number | boolean;
...
export type CourseType = {
    sourceValue?: Course4 | string | number | boolean | null | undefined;
...
export const CourseSourceValue$inboundSchema: z.ZodType<CourseSourceValue, z.ZodTypeDef, unknown> =
    z.union([z.lazy(() => Course4$inboundSchema), z.string(), z.number(), z.boolean()]);

/** @internal */
export type CourseSourceValue$Outbound = Course4$Outbound | string | number | boolean;
...
export const CourseSourceValue$outboundSchema: z.ZodType<
    ...
    z.ZodTypeDef,
    CourseSourceValue
> = z.union([z.lazy(() => Course4$outboundSchema), z.string(), z.number(), z.boolean()]);
...
export type CourseType$Outbound = {
    source_value?: Course4$Outbound | string | number | boolean | null | undefined;
