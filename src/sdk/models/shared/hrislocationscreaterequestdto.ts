 ...
 * The country code
 */
export class HrisLocationsCreateRequestDtoCountry extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class HrisLocationsCreateRequestDto extends SpeakeasyBase {
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "country" })
    @Type(() => HrisLocationsCreateRequestDtoCountry)
    country?: HrisLocationsCreateRequestDtoCountry;
