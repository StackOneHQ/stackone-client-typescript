...
import { Offer, Offer$inboundSchema, Offer$Outbound, Offer$outboundSchema } from "./offer.js";
import {
    RawResponse,
...
/** @internal */
export const OffersResult$inboundSchema: z.ZodType<OffersResult, z.ZodTypeDef, unknown> = z.object({
