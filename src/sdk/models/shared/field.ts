...
/** @internal */
export const Field2$inboundSchema: z.ZodNativeEnum<typeof Field2> = z.nativeEnum(Field2);

/** @internal */
export const Field2$outboundSchema: z.ZodNativeEnum<typeof Field2> = Field2$inboundSchema;
...
/** @internal */
export const RequiredT$inboundSchema: z.ZodType<RequiredT, z.ZodTypeDef, unknown> = z.union([
    z.boolean(),
...
/** @internal */
export const RequiredT$outboundSchema: z.ZodType<RequiredT$Outbound, z.ZodTypeDef, RequiredT> =
...
/** @internal */
export const FieldType$inboundSchema: z.ZodType<FieldTypeOpen, z.ZodTypeDef, unknown> = z.union([
    z.nativeEnum(FieldType),
    z.string().transform(catchUnrecognizedEnum),
]);

/** @internal */
export const FieldType$outboundSchema: z.ZodType<FieldTypeOpen, z.ZodTypeDef, FieldTypeOpen> =
    z.union([z.nativeEnum(FieldType), z.string().and(z.custom<Unrecognized<string>>())]);
...
/** @internal */
export const Field$outboundSchema: z.ZodType<Field$Outbound, z.ZodTypeDef, Field> = z
    .object({
        id: z.nullable(z.string()).optional(),
        label: z.nullable(z.string()).optional(),
