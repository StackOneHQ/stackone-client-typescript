...
export namespace MarketingCreateEmailTemplateRequestDto$ {
    ...
    export const inboundSchema = MarketingCreateEmailTemplateRequestDto$inboundSchema;
    /** @deprecated use `MarketingCreateEmailTemplateRequestDto$outboundSchema` instead. */
    export const outboundSchema = MarketingCreateEmailTemplateRequestDto$outboundSchema;
