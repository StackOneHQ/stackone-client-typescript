 ...
 * The category of the file
 */
export type HrisDocumentApiModelValueOpen = OpenEnum<
  typeof HrisDocumentApiModelValue
>;
...
export type HrisDocumentApiModelCategory = {
   ...
   * The category of the file
   */
  value?: HrisDocumentApiModelValueOpen | null | undefined;
};
 ...
 * The file format of the file, expressed as a file extension
 */
export type HrisDocumentApiModelSchemasValueOpen = OpenEnum<
...
export type HrisDocumentApiModelFileFormat = {
   ...
   * The file format of the file, expressed as a file extension
   */
  value?: HrisDocumentApiModelSchemasValueOpen | null | undefined;
};
 ...
 * The category of the file
 */
export enum HrisDocumentApiModelSchemasTypeValue {
  Application = "application",
  Academic = "academic",
  Contract = "contract",
  Certificates = "certificates",
 ...
 * The category of the file
 */
export type HrisDocumentApiModelSchemasTypeValueOpen = OpenEnum<
  typeof HrisDocumentApiModelSchemasTypeValue
>;
...
export type HrisDocumentApiModelType = {
   ...
   * The category of the file
   */
  value?: HrisDocumentApiModelSchemasTypeValueOpen | null | undefined;
};
...
export type HrisDocumentApiModel = {
   ...
   * The file format of the file
   */
  fileFormat?: HrisDocumentApiModelFileFormat | null | undefined;
  /**
   * Unique identifier
   */
...
export namespace HrisDocumentApiModelSchemasSourceValue$ {
  ...
  export const inboundSchema =
    HrisDocumentApiModelSchemasSourceValue$inboundSchema;
...
/** @internal */
export const HrisDocumentApiModelSchemasTypeSourceValue$outboundSchema:
  z.ZodType<
...
export namespace HrisDocumentApiModelSchemasTypeSourceValue$ {
  ...
  export const inboundSchema =
    HrisDocumentApiModelSchemasTypeSourceValue$inboundSchema;
...
export namespace HrisDocumentApiModelSchemasTypeValue$ {
  ...
  export const inboundSchema =
    HrisDocumentApiModelSchemasTypeValue$inboundSchema;
  /** @deprecated use `HrisDocumentApiModelSchemasTypeValue$outboundSchema` instead. */
  export const outboundSchema =
    HrisDocumentApiModelSchemasTypeValue$outboundSchema;
}
...
> = z.object({
  ...
  value: z.nullable(HrisDocumentApiModelSchemasTypeValue$inboundSchema)
    .optional(),
}).transform((v) => {
  return remap$(v, {
    "source_value": "sourceValue",
...
> = z.object({
  ...
  value: z.nullable(HrisDocumentApiModelSchemasTypeValue$outboundSchema)
    .optional(),
}).transform((v) => {
  return remap$(v, {
    sourceValue: "source_value",
...
export const HrisDocumentApiModel$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  category: z.nullable(z.lazy(() => HrisDocumentApiModelCategory$inboundSchema))
    .optional(),
  ...
  file_format: z.nullable(
    z.lazy(() => HrisDocumentApiModelFileFormat$inboundSchema),
  ).optional(),
...
> = z.object({
  category: z.nullable(
    z.lazy(() => HrisDocumentApiModelCategory$outboundSchema),
  ).optional(),
  ...
  fileFormat: z.nullable(
    z.lazy(() => HrisDocumentApiModelFileFormat$outboundSchema),
  ).optional(),
  id: z.nullable(z.string()).optional(),
  name: z.nullable(z.string()).optional(),
  path: z.nullable(z.string()).optional(),
