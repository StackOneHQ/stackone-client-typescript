 ...
 * The content type of the attachment.
 */
export type ApplicationAttachmentValueOpen = OpenEnum<typeof ApplicationAttachmentValue>;
...
export namespace ApplicationAttachmentValue$ {
    export const inboundSchema: z.ZodType<ApplicationAttachmentValueOpen, z.ZodTypeDef, unknown> =
        z.union([
