...
import { ChannelsEnum, ChannelsEnum$ } from "./channelsenum.js";
...
export namespace CampaignValue$ {
    export const inboundSchema: z.ZodType<CampaignValueOpen, z.ZodTypeDef, unknown> = z.union([
        z.nativeEnum(CampaignValue),
        z.string().transform(catchUnrecognizedEnum),
    ]);

    export const outboundSchema: z.ZodType<CampaignValueOpen, z.ZodTypeDef, CampaignValueOpen> =
...
export namespace CampaignSchemasValue$ {
    export const inboundSchema: z.ZodType<CampaignSchemasValueOpen, z.ZodTypeDef, unknown> =
