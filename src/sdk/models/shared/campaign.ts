...
/** @internal */
export const Archived$inboundSchema: z.ZodType<Archived, z.ZodTypeDef, unknown> = z.union([
    z.boolean(),
    Two$inboundSchema,
]);
...
/** @internal */
export const Archived$outboundSchema: z.ZodType<Archived$Outbound, z.ZodTypeDef, Archived> =
...
/** @internal */
export const Campaign2$inboundSchema: z.ZodNativeEnum<typeof Campaign2> = z.nativeEnum(Campaign2);

/** @internal */
export const Campaign2$outboundSchema: z.ZodNativeEnum<typeof Campaign2> = Campaign2$inboundSchema;
...
/** @internal */
export const Draft$inboundSchema: z.ZodType<Draft, z.ZodTypeDef, unknown> = z.union([
    z.boolean(),
...
/** @internal */
export const Draft$outboundSchema: z.ZodType<Draft$Outbound, z.ZodTypeDef, Draft> = z.union([
    z.boolean(),
...
/** @internal */
export const Campaign4$inboundSchema: z.ZodType<Campaign4, z.ZodTypeDef, unknown> = z.object({});

/** @internal */
export type Campaign4$Outbound = {};

/** @internal */
export const Campaign4$outboundSchema: z.ZodType<Campaign4$Outbound, z.ZodTypeDef, Campaign4> =
    z.object({});
...
/** @internal */
export const CampaignValue$inboundSchema: z.ZodType<CampaignValueOpen, z.ZodTypeDef, unknown> =
    z.union([z.nativeEnum(CampaignValue), z.string().transform(catchUnrecognizedEnum)]);
...
export const CampaignValue$outboundSchema: z.ZodType<
    ...
    z.ZodTypeDef,
    CampaignValueOpen
> = z.union([z.nativeEnum(CampaignValue), z.string().and(z.custom<Unrecognized<string>>())]);
...
/** @internal */
export const ScheduleType$inboundSchema: z.ZodType<ScheduleType, z.ZodTypeDef, unknown> = z
    .object({
        source_value: z
            .nullable(
                z.union([
...
/** @internal */
export const CampaignSchemas4$inboundSchema: z.ZodType<CampaignSchemas4, z.ZodTypeDef, unknown> =
    z.object({});
...
export const CampaignSchemasValue$inboundSchema: z.ZodType<
    ...
    z.ZodTypeDef,
    unknown
> = z.union([z.nativeEnum(CampaignSchemasValue), z.string().transform(catchUnrecognizedEnum)]);
...
export const CampaignSchemasValue$outboundSchema: z.ZodType<
    ...
    z.ZodTypeDef,
    CampaignSchemasValueOpen
> = z.union([z.nativeEnum(CampaignSchemasValue), z.string().and(z.custom<Unrecognized<string>>())]);
...
/** @internal */
export const Campaign$inboundSchema: z.ZodType<Campaign, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const Campaign$outboundSchema: z.ZodType<Campaign$Outbound, z.ZodTypeDef, Campaign> = z
    .object({
