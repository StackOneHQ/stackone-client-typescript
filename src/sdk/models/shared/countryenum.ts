...
/** @internal */
export const CountryEnumValue$ = z.nativeEnum(CountryEnumValue);
...
export namespace CountryEnum$ {
    ...
    export const inboundSchema: z.ZodType<CountryEnum, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CountryEnum> = z
        .object({
