...
/** @internal */
export const HRISDepartment4$inboundSchema: z.ZodType<HRISDepartment4, z.ZodTypeDef, unknown> =
    z.object({});
...
export const HRISDepartmentValue$inboundSchema: z.ZodType<
    ...
    z.ZodTypeDef,
    unknown
> = z.union([z.nativeEnum(HRISDepartmentValue), z.string().transform(catchUnrecognizedEnum)]);
...
export const HRISDepartmentValue$outboundSchema: z.ZodType<
    ...
    z.ZodTypeDef,
    HRISDepartmentValueOpen
> = z.union([z.nativeEnum(HRISDepartmentValue), z.string().and(z.custom<Unrecognized<string>>())]);
...
/** @internal */
export const HRISDepartment$inboundSchema: z.ZodType<HRISDepartment, z.ZodTypeDef, unknown> = z
    .object({
