 ...
 * The status of the interview.
 */
export type ScheduledInterviewValueOpen = OpenEnum<typeof ScheduledInterviewValue>;
...
export const ScheduledInterviewValue$inboundSchema: z.ZodType<
    ...
    z.ZodTypeDef,
    unknown
> = z.union([z.nativeEnum(ScheduledInterviewValue), z.string().transform(catchUnrecognizedEnum)]);
...
export namespace ScheduledInterviewInterviewStatus$ {
    ...
    export const outboundSchema = ScheduledInterviewInterviewStatus$outboundSchema;
...
> = z
    .object({
        ...
        interview_stage: z
            .nullable(z.lazy(() => ScheduledInterviewInterviewStage$inboundSchema))
            .optional(),
        interview_stage_id: z.nullable(z.string()).optional(),
        interview_status: z
            .nullable(z.lazy(() => ScheduledInterviewInterviewStatus$inboundSchema))
            .optional(),
...
export type ScheduledInterview$Outbound = {
    ...
    interview_stage?: ScheduledInterviewInterviewStage$Outbound | null | undefined;
    interview_stage_id?: string | null | undefined;
    interview_status?: ScheduledInterviewInterviewStatus$Outbound | null | undefined;
...
> = z
    .object({
        ...
        interviewStage: z
            .nullable(z.lazy(() => ScheduledInterviewInterviewStage$outboundSchema))
            .optional(),
        interviewStageId: z.nullable(z.string()).optional(),
        interviewStatus: z
            .nullable(z.lazy(() => ScheduledInterviewInterviewStatus$outboundSchema))
            .optional(),
