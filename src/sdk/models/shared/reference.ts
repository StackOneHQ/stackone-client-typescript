...
/** @internal */
export const Reference2$inboundSchema: z.ZodNativeEnum<typeof Reference2> =
    z.nativeEnum(Reference2);
...
/** @internal */
export const ReferenceActive$inboundSchema: z.ZodType<ReferenceActive, z.ZodTypeDef, unknown> =
...
/** @internal */
export const Reference$inboundSchema: z.ZodType<Reference, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const Reference$outboundSchema: z.ZodType<Reference$Outbound, z.ZodTypeDef, Reference> = z
    .object({
