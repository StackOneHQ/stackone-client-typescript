...
export type Content = {
     ...
     * The file format of the file
     */
    fileFormat?: ContentFileFormat | null | undefined;
    /**
...
/** @internal */
export namespace ContentFileFormat$ {
    export const inboundSchema: z.ZodType<ContentFileFormat, z.ZodTypeDef, unknown> = z
        .object({
            source_value: z
                .nullable(
                    z.union([
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ContentFileFormat> = z
        .object({
            sourceValue: z
                .nullable(
                    z.union([
...
export namespace Content$ {
    export const inboundSchema: z.ZodType<Content, z.ZodTypeDef, unknown> = z
        .object({
            file_format: z.nullable(z.lazy(() => ContentFileFormat$.inboundSchema)).optional(),
    ...
    export type Outbound = {
        file_format?: ContentFileFormat$.Outbound | null | undefined;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, Content> = z
        .object({
            fileFormat: z.nullable(z.lazy(() => ContentFileFormat$.outboundSchema)).optional(),
