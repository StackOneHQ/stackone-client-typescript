...
import {
  ...
  HRISBankDetails$outboundSchema,
...
export type Employee$Outbound = {
  ...
  bank_details?: Array<HRISBankDetails$Outbound> | null | undefined;
...
> = z.object({
  ...
  bankDetails: z.nullable(z.array(HRISBankDetails$outboundSchema)).optional(),
