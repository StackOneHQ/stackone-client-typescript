...
export namespace PatchAccountExternalDtoCredentials$ {
    ...
    export const outboundSchema = PatchAccountExternalDtoCredentials$outboundSchema;
...
export namespace PatchAccountExternalDtoSetupInformation$ {
    ...
    export const inboundSchema = PatchAccountExternalDtoSetupInformation$inboundSchema;
    /** @deprecated use `PatchAccountExternalDtoSetupInformation$outboundSchema` instead. */
    export const outboundSchema = PatchAccountExternalDtoSetupInformation$outboundSchema;
...
> = z
    .object({
        ...
        credentials: z
            .nullable(z.lazy(() => PatchAccountExternalDtoCredentials$inboundSchema))
            .optional(),
        ...
        setup_information: z
            .nullable(z.lazy(() => PatchAccountExternalDtoSetupInformation$inboundSchema))
            .optional(),
    })
    .transform((v) => {
        return remap$(v, {
...
export type PatchAccountExternalDto$Outbound = {
    ...
    setup_information?: PatchAccountExternalDtoSetupInformation$Outbound | null | undefined;
};
...
> = z
    .object({
        ...
        credentials: z
            .nullable(z.lazy(() => PatchAccountExternalDtoCredentials$outboundSchema))
            .optional(),
        environment: z.nullable(z.string()).optional(),
        ...
        setupInformation: z
            .nullable(z.lazy(() => PatchAccountExternalDtoSetupInformation$outboundSchema))
            .optional(),
    })
    .transform((v) => {
        return remap$(v, {
