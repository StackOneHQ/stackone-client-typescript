...
export namespace ContentPaginated$ {
    export const inboundSchema: z.ZodType<ContentPaginated, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ContentPaginated> = z
        .object({
