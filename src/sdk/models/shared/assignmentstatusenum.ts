...
export type SourceValue = AssignmentStatusEnum4 | string | number | boolean;
...
export type AssignmentStatusEnum = {
    sourceValue?: AssignmentStatusEnum4 | string | number | boolean | null | undefined;
...
/** @internal */
export type SourceValue$Outbound = AssignmentStatusEnum4$Outbound | string | number | boolean;
...
export type AssignmentStatusEnum$Outbound = {
    source_value?: AssignmentStatusEnum4$Outbound | string | number | boolean | null | undefined;
