...
/** @internal */
export const IamGroup4$inboundSchema: z.ZodType<IamGroup4, z.ZodTypeDef, unknown> = z.object({});

/** @internal */
export type IamGroup4$Outbound = {};

/** @internal */
export const IamGroup4$outboundSchema: z.ZodType<IamGroup4$Outbound, z.ZodTypeDef, IamGroup4> =
    z.object({});
...
/** @internal */
export const IamGroupValue$inboundSchema: z.ZodType<IamGroupValueOpen, z.ZodTypeDef, unknown> =
    z.union([z.nativeEnum(IamGroupValue), z.string().transform(catchUnrecognizedEnum)]);
...
export const IamGroupValue$outboundSchema: z.ZodType<
    ...
    z.ZodTypeDef,
    IamGroupValueOpen
> = z.union([z.nativeEnum(IamGroupValue), z.string().and(z.custom<Unrecognized<string>>())]);
...
/** @internal */
export const IamGroupType$inboundSchema: z.ZodType<IamGroupType, z.ZodTypeDef, unknown> = z
    .object({
        source_value: z
            .nullable(
                z.union([
...
/** @internal */
export const IamGroup$inboundSchema: z.ZodType<IamGroup, z.ZodTypeDef, unknown> = z
    .object({
        created_at: z
            .nullable(
                z
...
/** @internal */
export const IamGroup$outboundSchema: z.ZodType<IamGroup$Outbound, z.ZodTypeDef, IamGroup> = z
    .object({
