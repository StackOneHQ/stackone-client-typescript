...
export const ConnectorsMetaCategory$inboundSchema: z.ZodType<
    ...
    z.ZodTypeDef,
    unknown
> = z.union([z.nativeEnum(ConnectorsMetaCategory), z.string().transform(catchUnrecognizedEnum)]);
...
/** @internal */
export const Images$outboundSchema: z.ZodType<Images$Outbound, z.ZodTypeDef, Images> = z
    .object({
...
/** @internal */
export const Resources$inboundSchema: z.ZodType<Resources, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const Resources$outboundSchema: z.ZodType<Resources$Outbound, z.ZodTypeDef, Resources> =
    z.object({
...
/** @internal */
export const ConnectorsMeta$inboundSchema: z.ZodType<ConnectorsMeta, z.ZodTypeDef, unknown> = z
    .object({
