...
/** @internal */
export const LanguageEnum4$inboundSchema: z.ZodType<
  LanguageEnum4,
  z.ZodTypeDef,
  unknown
> = z.object({});
...
/** @internal */
export const LanguageEnum4$outboundSchema: z.ZodType<
...
/** @internal */
export const LanguageEnumSourceValue$outboundSchema: z.ZodType<
  LanguageEnumSourceValue$Outbound,
  z.ZodTypeDef,
  LanguageEnumSourceValue
> = z.union([
  z.string(),
...
/** @internal */
export const LanguageEnumValue$inboundSchema: z.ZodType<
...
> = z.object({
  ...
  value: z.nullable(LanguageEnumValue$inboundSchema).optional(),
}).transform((v) => {
  return remap$(v, {
...
/** @internal */
export const LanguageEnum$outboundSchema: z.ZodType<
...
> = z.object({
  ...
  value: z.nullable(LanguageEnumValue$outboundSchema).optional(),
}).transform((v) => {
  return remap$(v, {
