...
> = z
    .object({
        ...
        filter: z.nullable(z.lazy(() => LmsListCoursesQueryParamFilter$inboundSchema)).optional(),
...
> = z
    .object({
        fields: z.nullable(z.string()).optional(),
        filter: z.nullable(z.lazy(() => LmsListCoursesQueryParamFilter$outboundSchema)).optional(),
        next: z.nullable(z.string()).optional(),
        page: z.nullable(z.string()).optional(),
