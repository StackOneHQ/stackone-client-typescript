...
export type AtsListRejectedReasonsRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: AtsListRejectedReasonsQueryParamProxy | undefined;
    /**
...
export namespace AtsListRejectedReasonsRequest$ {
    export type Inbound = {
        ...
        proxy?: AtsListRejectedReasonsQueryParamProxy$.Inbound | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<AtsListRejectedReasonsRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z.lazy(() => AtsListRejectedReasonsQueryParamProxy$.inboundSchema).optional(),
    ...
    export type Outbound = {
        ...
        page?: string | null | undefined;
        page_size?: string | null | undefined;
        proxy?: AtsListRejectedReasonsQueryParamProxy$.Outbound | undefined;
        raw?: boolean | null | undefined;
        sync_token?: string | null | undefined;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AtsListRejectedReasonsRequest> =
        z
            .object({
                ...
                proxy: z
                    .lazy(() => AtsListRejectedReasonsQueryParamProxy$.outboundSchema)
                    .optional(),
                raw: z.boolean().nullable().optional(),
