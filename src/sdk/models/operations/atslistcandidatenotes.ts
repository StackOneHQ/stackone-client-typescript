...
export class AtsListCandidateNotesRequest extends SpeakeasyBase {
    /**
...
export class AtsListCandidateNotesResponse extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata()
    notesPaginated?: shared.NotesPaginated;
