...
export type HrisGetCompanyRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: HrisGetCompanyQueryParamProxy | undefined;
    /**
...
export namespace HrisGetCompanyRequest$ {
    export type Inbound = {
        ...
        proxy?: HrisGetCompanyQueryParamProxy$.Inbound | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<HrisGetCompanyRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z.lazy(() => HrisGetCompanyQueryParamProxy$.inboundSchema).optional(),
    ...
    export type Outbound = {
        ...
        page?: string | null | undefined;
        page_size?: string | null | undefined;
        proxy?: HrisGetCompanyQueryParamProxy$.Outbound | undefined;
        raw?: boolean | null | undefined;
        sync_token?: string | null | undefined;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, HrisGetCompanyRequest> = z
        .object({
            ...
            proxy: z.lazy(() => HrisGetCompanyQueryParamProxy$.outboundSchema).optional(),
            raw: z.boolean().nullable().optional(),
