...
export class AtsGetApplicationOfferRequest extends SpeakeasyBase {
    /**
...
export class AtsGetApplicationOfferResponse extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata()
    offersResult?: shared.OffersResult;
