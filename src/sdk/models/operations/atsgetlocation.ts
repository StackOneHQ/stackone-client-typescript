 ...
 */
export type AtsGetLocationQueryParamProxy = {};
...
export type AtsGetLocationRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with 'proxy' key
     */
    proxy?: AtsGetLocationQueryParamProxy | null | undefined;
    /**
...
/** @internal */
export namespace AtsGetLocationQueryParamProxy$ {
    export type Inbound = {};

    export const inboundSchema: z.ZodType<AtsGetLocationQueryParamProxy, z.ZodTypeDef, Inbound> =
        z.object({});

    export type Outbound = {};

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AtsGetLocationQueryParamProxy> =
        z.object({});
}
...
export namespace AtsGetLocationRequest$ {
    export type Inbound = {
        ...
        proxy?: AtsGetLocationQueryParamProxy$.Inbound | null | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<AtsGetLocationRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z
                .nullable(z.lazy(() => AtsGetLocationQueryParamProxy$.inboundSchema))
                .optional(),
    ...
    export type Outbound = {
        ...
        proxy?: AtsGetLocationQueryParamProxy$.Outbound | null | undefined;
        raw: boolean | null;
        sync_token?: string | null | undefined;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AtsGetLocationRequest> = z
        .object({
            ...
            proxy: z
                .nullable(z.lazy(() => AtsGetLocationQueryParamProxy$.outboundSchema))
                .optional(),
            raw: z.nullable(z.boolean().default(false)),
