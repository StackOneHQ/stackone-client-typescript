...
export class AtsGetLocationRequest extends SpeakeasyBase {
    /**
...
export class AtsGetLocationResponse extends SpeakeasyBase {
    /**
     * The location with the given identifier was retrieved.
     */
    @SpeakeasyMetadata()
    atsLocationResult?: shared.ATSLocationResult;
