...
export class HrisGetLocationRequest extends SpeakeasyBase {
    /**
...
export class HrisGetLocationResponse extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata()
    hrisLocationResult?: shared.HRISLocationResult;
