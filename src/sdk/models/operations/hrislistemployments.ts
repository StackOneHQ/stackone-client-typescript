...
export type HrisListEmploymentsRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: HrisListEmploymentsQueryParamProxy | undefined;
    /**
...
export namespace HrisListEmploymentsRequest$ {
    export type Inbound = {
        ...
        proxy?: HrisListEmploymentsQueryParamProxy$.Inbound | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<HrisListEmploymentsRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z.lazy(() => HrisListEmploymentsQueryParamProxy$.inboundSchema).optional(),
    ...
    export type Outbound = {
        ...
        page?: string | null | undefined;
        page_size?: string | null | undefined;
        proxy?: HrisListEmploymentsQueryParamProxy$.Outbound | undefined;
        raw?: boolean | null | undefined;
        sync_token?: string | null | undefined;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, HrisListEmploymentsRequest> = z
        .object({
            ...
            proxy: z.lazy(() => HrisListEmploymentsQueryParamProxy$.outboundSchema).optional(),
            raw: z.boolean().nullable().optional(),
