 ...
 */
export type HrisListEmploymentsQueryParamProxy = {};
...
export type HrisListEmploymentsRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: HrisListEmploymentsQueryParamProxy | null | undefined;
    /**
...
/** @internal */
export namespace HrisListEmploymentsQueryParamProxy$ {
    export type Inbound = {};
...
export namespace HrisListEmploymentsRequest$ {
    export type Inbound = {
        ...
        proxy?: HrisListEmploymentsQueryParamProxy$.Inbound | null | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<HrisListEmploymentsRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z
                .nullable(z.lazy(() => HrisListEmploymentsQueryParamProxy$.inboundSchema))
                .optional(),
    ...
    export type Outbound = {
        ...
        page?: string | null | undefined;
        page_size?: string | null | undefined;
        proxy?: HrisListEmploymentsQueryParamProxy$.Outbound | null | undefined;
        raw?: boolean | null | undefined;
        sync_token?: string | null | undefined;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, HrisListEmploymentsRequest> = z
        .object({
            ...
            proxy: z
                .nullable(z.lazy(() => HrisListEmploymentsQueryParamProxy$.outboundSchema))
                .optional(),
            raw: z.nullable(z.boolean()).optional(),
...
export namespace HrisListEmploymentsResponse$ {
    ...
    export const inboundSchema: z.ZodType<HrisListEmploymentsResponse, z.ZodTypeDef, Inbound> = z
        ...
        .transform((v) => {
            return {
                ...
                ...(v.EmploymentsPaginated === undefined
                    ? null
                    : { employmentsPaginated: v.EmploymentsPaginated }),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, HrisListEmploymentsResponse> = z
        .object({
            contentType: z.string(),
