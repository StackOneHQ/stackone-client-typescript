...
export namespace IamListGroupsQueryParamFilter$ {
    export const inboundSchema: z.ZodType<IamListGroupsQueryParamFilter, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, IamListGroupsQueryParamFilter> =
        z
            .object({
...
export namespace IamListGroupsRequest$ {
    export const inboundSchema: z.ZodType<IamListGroupsRequest, z.ZodTypeDef, unknown> = z
        .object({
            ...
            filter: z
                .nullable(z.lazy(() => IamListGroupsQueryParamFilter$.inboundSchema))
                .optional(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, IamListGroupsRequest> = z
        .object({
            ...
            fields: z.nullable(z.string()).optional(),
            filter: z
                .nullable(z.lazy(() => IamListGroupsQueryParamFilter$.outboundSchema))
                .optional(),
            next: z.nullable(z.string()).optional(),
            page: z.nullable(z.string()).optional(),
