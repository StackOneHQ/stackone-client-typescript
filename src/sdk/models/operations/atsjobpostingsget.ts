...
export class AtsJobPostingsGetRequest extends SpeakeasyBase {
    /**
...
export class AtsJobPostingsGetResponse extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata()
    jobPostingResult?: shared.JobPostingResult;
