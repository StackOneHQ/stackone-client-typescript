...
export type MarketingListCampaignsRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: MarketingListCampaignsQueryParamProxy | undefined;
    /**
...
export namespace MarketingListCampaignsRequest$ {
    export type Inbound = {
        ...
        proxy?: MarketingListCampaignsQueryParamProxy$.Inbound | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<MarketingListCampaignsRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z.lazy(() => MarketingListCampaignsQueryParamProxy$.inboundSchema).optional(),
    ...
    export type Outbound = {
        ...
        page?: string | null | undefined;
        page_size?: string | null | undefined;
        proxy?: MarketingListCampaignsQueryParamProxy$.Outbound | undefined;
        raw?: boolean | null | undefined;
        sync_token?: string | null | undefined;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, MarketingListCampaignsRequest> =
        z
            .object({
                ...
                proxy: z
                    .lazy(() => MarketingListCampaignsQueryParamProxy$.outboundSchema)
                    .optional(),
                raw: z.boolean().nullable().optional(),
