...
export class MarketingListOmniChannelTemplatesRequest extends SpeakeasyBase {
    /**
...
export class MarketingListOmniChannelTemplatesResponse extends SpeakeasyBase {
    /**
