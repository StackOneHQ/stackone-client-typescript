...
export type AtsGetJobRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: AtsGetJobQueryParamProxy | undefined;
    /**
...
export namespace AtsGetJobRequest$ {
    export type Inbound = {
        ...
        proxy?: AtsGetJobQueryParamProxy$.Inbound | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<AtsGetJobRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z.lazy(() => AtsGetJobQueryParamProxy$.inboundSchema).optional(),
    ...
    export type Outbound = {
        ...
        page?: string | null | undefined;
        page_size?: string | null | undefined;
        proxy?: AtsGetJobQueryParamProxy$.Outbound | undefined;
        raw?: boolean | null | undefined;
        sync_token?: string | null | undefined;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AtsGetJobRequest> = z
        .object({
            ...
            proxy: z.lazy(() => AtsGetJobQueryParamProxy$.outboundSchema).optional(),
            raw: z.boolean().nullable().optional(),
