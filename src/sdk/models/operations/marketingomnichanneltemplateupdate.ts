...
export class MarketingOmniChannelTemplateUpdateRequest extends SpeakeasyBase {
...
export class MarketingOmniChannelTemplateUpdateResponse extends SpeakeasyBase {
    /**
