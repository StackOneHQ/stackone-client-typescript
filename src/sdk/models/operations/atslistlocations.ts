...
export class AtsListLocationsRequest extends SpeakeasyBase {
    /**
...
export class AtsListLocationsResponse extends SpeakeasyBase {
    /**
     * The list of locations was retrieved.
     */
    @SpeakeasyMetadata()
    atsLocationsPaginated?: shared.ATSLocationsPaginated;
