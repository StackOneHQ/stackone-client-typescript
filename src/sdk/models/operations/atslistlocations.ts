...
export type AtsListLocationsRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: AtsListLocationsQueryParamProxy | undefined;
    /**
...
export namespace AtsListLocationsRequest$ {
    export type Inbound = {
        ...
        proxy?: AtsListLocationsQueryParamProxy$.Inbound | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<AtsListLocationsRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z.lazy(() => AtsListLocationsQueryParamProxy$.inboundSchema).optional(),
    ...
    export type Outbound = {
        ...
        page?: string | null | undefined;
        page_size?: string | null | undefined;
        proxy?: AtsListLocationsQueryParamProxy$.Outbound | undefined;
        raw?: boolean | null | undefined;
        sync_token?: string | null | undefined;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AtsListLocationsRequest> = z
        .object({
            ...
            proxy: z.lazy(() => AtsListLocationsQueryParamProxy$.outboundSchema).optional(),
            raw: z.boolean().nullable().optional(),
