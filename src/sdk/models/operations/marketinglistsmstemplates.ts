...
/** @internal */
export const MarketingListSmsTemplatesQueryParamFilter$outboundSchema: z.ZodType<
...
export namespace MarketingListSmsTemplatesQueryParamFilter$ {
    ...
    export const inboundSchema = MarketingListSmsTemplatesQueryParamFilter$inboundSchema;
    /** @deprecated use `MarketingListSmsTemplatesQueryParamFilter$outboundSchema` instead. */
    export const outboundSchema = MarketingListSmsTemplatesQueryParamFilter$outboundSchema;
...
> = z
    .object({
        ...
        filter: z
            .nullable(z.lazy(() => MarketingListSmsTemplatesQueryParamFilter$inboundSchema))
            .optional(),
...
export type MarketingListSmsTemplatesRequest$Outbound = {
    fields?: string | null | undefined;
    filter?: MarketingListSmsTemplatesQueryParamFilter$Outbound | null | undefined;
    next?: string | null | undefined;
    page?: string | null | undefined;
...
> = z
    .object({
        fields: z.nullable(z.string()).optional(),
        filter: z
            .nullable(z.lazy(() => MarketingListSmsTemplatesQueryParamFilter$outboundSchema))
            .optional(),
        next: z.nullable(z.string()).optional(),
        page: z.nullable(z.string()).optional(),
...
export namespace MarketingListSmsTemplatesResponse$ {
    ...
    export const outboundSchema = MarketingListSmsTemplatesResponse$outboundSchema;
