...
export type AtsGetApplicationCustomFieldDefinitionResponse = {
     ...
     */
    customFieldDefinitionResultApiModel?: shared.CustomFieldDefinitionResultApiModel | undefined;
    /**
...
/** @internal */
export const AtsGetApplicationCustomFieldDefinitionRequest$inboundSchema: z.ZodType<
...
/** @internal */
export const AtsGetApplicationCustomFieldDefinitionRequest$outboundSchema: z.ZodType<
...
export namespace AtsGetApplicationCustomFieldDefinitionRequest$ {
    ...
    export const inboundSchema = AtsGetApplicationCustomFieldDefinitionRequest$inboundSchema;
    /** @deprecated use `AtsGetApplicationCustomFieldDefinitionRequest$outboundSchema` instead. */
    export const outboundSchema = AtsGetApplicationCustomFieldDefinitionRequest$outboundSchema;
...
/** @internal */
export const AtsGetApplicationCustomFieldDefinitionResponse$inboundSchema: z.ZodType<
...
> = z
    .object({
        ...
        CustomFieldDefinitionResultApiModel:
            shared.CustomFieldDefinitionResultApiModel$inboundSchema.optional(),
...
/** @internal */
export const AtsGetApplicationCustomFieldDefinitionResponse$outboundSchema: z.ZodType<
...
> = z
    .object({
        contentType: z.string(),
        customFieldDefinitionResultApiModel:
            shared.CustomFieldDefinitionResultApiModel$outboundSchema.optional(),
        statusCode: z.number().int(),
...
export namespace AtsGetApplicationCustomFieldDefinitionResponse$ {
    ...
    export const inboundSchema = AtsGetApplicationCustomFieldDefinitionResponse$inboundSchema;
    /** @deprecated use `AtsGetApplicationCustomFieldDefinitionResponse$outboundSchema` instead. */
    export const outboundSchema = AtsGetApplicationCustomFieldDefinitionResponse$outboundSchema;
    /** @deprecated use `AtsGetApplicationCustomFieldDefinitionResponse$Outbound` instead. */
    export type Outbound = AtsGetApplicationCustomFieldDefinitionResponse$Outbound;
}
