...
export class HrisListLocationsRequest extends SpeakeasyBase {
    /**
...
export class HrisListLocationsResponse extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata()
    hrisLocationsPaginated?: shared.HRISLocationsPaginated;
