...
export type HrisListLocationsRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: HrisListLocationsQueryParamProxy | null | undefined;
    /**
...
export namespace HrisListLocationsRequest$ {
    export type Inbound = {
        ...
        proxy?: HrisListLocationsQueryParamProxy$.Inbound | null | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<HrisListLocationsRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z
                .nullable(z.lazy(() => HrisListLocationsQueryParamProxy$.inboundSchema))
                .optional(),
    ...
    export type Outbound = {
        ...
        proxy?: HrisListLocationsQueryParamProxy$.Outbound | null | undefined;
        raw: boolean | null;
        sync_token?: string | null | undefined;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, HrisListLocationsRequest> = z
        .object({
            ...
            proxy: z
                .nullable(z.lazy(() => HrisListLocationsQueryParamProxy$.outboundSchema))
                .optional(),
            raw: z.nullable(z.boolean().default(false)),
