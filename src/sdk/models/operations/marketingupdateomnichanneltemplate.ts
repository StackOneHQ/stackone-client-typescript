...
export class MarketingUpdateOmniChannelTemplateRequest extends SpeakeasyBase {
...
export class MarketingUpdateOmniChannelTemplateResponse extends SpeakeasyBase {
    /**
