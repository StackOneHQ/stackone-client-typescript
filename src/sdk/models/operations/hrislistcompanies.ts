...
export type HrisListCompaniesRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: HrisListCompaniesQueryParamProxy | undefined;
    /**
...
export namespace HrisListCompaniesRequest$ {
    export type Inbound = {
        ...
        proxy?: HrisListCompaniesQueryParamProxy$.Inbound | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<HrisListCompaniesRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z.lazy(() => HrisListCompaniesQueryParamProxy$.inboundSchema).optional(),
    ...
    export type Outbound = {
        ...
        page?: string | null | undefined;
        page_size?: string | null | undefined;
        proxy?: HrisListCompaniesQueryParamProxy$.Outbound | undefined;
        raw?: boolean | null | undefined;
        sync_token?: string | null | undefined;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, HrisListCompaniesRequest> = z
        .object({
            ...
            proxy: z.lazy(() => HrisListCompaniesQueryParamProxy$.outboundSchema).optional(),
            raw: z.boolean().nullable().optional(),
