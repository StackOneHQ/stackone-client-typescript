...
export type AtsGetRejectedReasonRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: AtsGetRejectedReasonQueryParamProxy | undefined;
    /**
...
export namespace AtsGetRejectedReasonRequest$ {
    export type Inbound = {
        ...
        proxy?: AtsGetRejectedReasonQueryParamProxy$.Inbound | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<AtsGetRejectedReasonRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z.lazy(() => AtsGetRejectedReasonQueryParamProxy$.inboundSchema).optional(),
    ...
    export type Outbound = {
        ...
        page?: string | null | undefined;
        page_size?: string | null | undefined;
        proxy?: AtsGetRejectedReasonQueryParamProxy$.Outbound | undefined;
        raw?: boolean | null | undefined;
        sync_token?: string | null | undefined;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AtsGetRejectedReasonRequest> = z
        .object({
            ...
            proxy: z.lazy(() => AtsGetRejectedReasonQueryParamProxy$.outboundSchema).optional(),
            raw: z.boolean().nullable().optional(),
