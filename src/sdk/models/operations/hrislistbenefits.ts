 ...
 */
export type HrisListBenefitsQueryParamProxy = {};
...
export type HrisListBenefitsRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with 'proxy' key
     */
    proxy?: HrisListBenefitsQueryParamProxy | null | undefined;
    /**
...
/** @internal */
export namespace HrisListBenefitsQueryParamProxy$ {
    export type Inbound = {};

    export const inboundSchema: z.ZodType<HrisListBenefitsQueryParamProxy, z.ZodTypeDef, Inbound> =
        z.object({});
...
export namespace HrisListBenefitsRequest$ {
    export type Inbound = {
        ...
        proxy?: HrisListBenefitsQueryParamProxy$.Inbound | null | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<HrisListBenefitsRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z
                .nullable(z.lazy(() => HrisListBenefitsQueryParamProxy$.inboundSchema))
                .optional(),
    ...
    export type Outbound = {
        ...
        proxy?: HrisListBenefitsQueryParamProxy$.Outbound | null | undefined;
        raw: boolean | null;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    };
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, HrisListBenefitsRequest> = z
        .object({
            ...
            proxy: z
                .nullable(z.lazy(() => HrisListBenefitsQueryParamProxy$.outboundSchema))
                .optional(),
            raw: z.nullable(z.boolean().default(false)),
