...
export type AtsListApplicationsScheduledInterviewsRequest = {
     ...
     * Filter parameters that allow greater customisation of the list response
     */
    filter?: AtsListApplicationsScheduledInterviewsQueryParamFilter | null | undefined;
    id: string;
    /**
     * The unified cursor
     */
...
export type AtsListApplicationsScheduledInterviewsResponse = {
     ...
     */
    scheduledInterviewsPaginated?: shared.ScheduledInterviewsPaginated | undefined;
    /**
...
/** @internal */
export const AtsListApplicationsScheduledInterviewsQueryParamFilter$inboundSchema: z.ZodType<
...
/** @internal */
export const AtsListApplicationsScheduledInterviewsQueryParamFilter$outboundSchema: z.ZodType<
...
export namespace AtsListApplicationsScheduledInterviewsQueryParamFilter$ {
    ...
    export type Outbound = AtsListApplicationsScheduledInterviewsQueryParamFilter$Outbound;
}

/** @internal */
export const AtsListApplicationsScheduledInterviewsRequest$inboundSchema: z.ZodType<
...
> = z
    .object({
        ...
        filter: z
            .nullable(
                z.lazy(() => AtsListApplicationsScheduledInterviewsQueryParamFilter$inboundSchema)
            )
            .optional(),
        id: z.string(),
...
export type AtsListApplicationsScheduledInterviewsRequest$Outbound = {
    fields?: string | null | undefined;
    filter?: AtsListApplicationsScheduledInterviewsQueryParamFilter$Outbound | null | undefined;
    id: string;
    next?: string | null | undefined;
    page?: string | null | undefined;
...
/** @internal */
export const AtsListApplicationsScheduledInterviewsRequest$outboundSchema: z.ZodType<
...
> = z
    .object({
        ...
        filter: z
            .nullable(
                z.lazy(() => AtsListApplicationsScheduledInterviewsQueryParamFilter$outboundSchema)
            )
            .optional(),
        id: z.string(),
        next: z.nullable(z.string()).optional(),
...
export namespace AtsListApplicationsScheduledInterviewsRequest$ {
    ...
    export const inboundSchema = AtsListApplicationsScheduledInterviewsRequest$inboundSchema;
    /** @deprecated use `AtsListApplicationsScheduledInterviewsRequest$outboundSchema` instead. */
    export const outboundSchema = AtsListApplicationsScheduledInterviewsRequest$outboundSchema;
...
/** @internal */
export const AtsListApplicationsScheduledInterviewsResponse$inboundSchema: z.ZodType<
...
> = z
    .object({
        ...
        ScheduledInterviewsPaginated: shared.ScheduledInterviewsPaginated$inboundSchema.optional(),
...
export type AtsListApplicationsScheduledInterviewsResponse$Outbound = {
    ContentType: string;
    ScheduledInterviewsPaginated?: shared.ScheduledInterviewsPaginated$Outbound | undefined;
    StatusCode: number;
    RawResponse: never;
};

/** @internal */
export const AtsListApplicationsScheduledInterviewsResponse$outboundSchema: z.ZodType<
...
> = z
    .object({
        contentType: z.string(),
        scheduledInterviewsPaginated: shared.ScheduledInterviewsPaginated$outboundSchema.optional(),
        statusCode: z.number().int(),
...
export namespace AtsListApplicationsScheduledInterviewsResponse$ {
    ...
    export const inboundSchema = AtsListApplicationsScheduledInterviewsResponse$inboundSchema;
    /** @deprecated use `AtsListApplicationsScheduledInterviewsResponse$outboundSchema` instead. */
    export const outboundSchema = AtsListApplicationsScheduledInterviewsResponse$outboundSchema;
    /** @deprecated use `AtsListApplicationsScheduledInterviewsResponse$Outbound` instead. */
    export type Outbound = AtsListApplicationsScheduledInterviewsResponse$Outbound;
}
