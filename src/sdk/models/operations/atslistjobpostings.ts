...
export class AtsListJobPostingsRequest extends SpeakeasyBase {
    /**
...
export class AtsListJobPostingsResponse extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata()
    jobPostingsPaginated?: shared.JobPostingsPaginated;
