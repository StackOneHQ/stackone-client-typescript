...
export type AtsListApplicationsRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: AtsListApplicationsQueryParamProxy | undefined;
    /**
...
export namespace AtsListApplicationsRequest$ {
    export type Inbound = {
        ...
        proxy?: AtsListApplicationsQueryParamProxy$.Inbound | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<AtsListApplicationsRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z.lazy(() => AtsListApplicationsQueryParamProxy$.inboundSchema).optional(),
    ...
    export type Outbound = {
        ...
        page?: string | null | undefined;
        page_size?: string | null | undefined;
        proxy?: AtsListApplicationsQueryParamProxy$.Outbound | undefined;
        raw?: boolean | null | undefined;
        sync_token?: string | null | undefined;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AtsListApplicationsRequest> = z
        .object({
            ...
            proxy: z.lazy(() => AtsListApplicationsQueryParamProxy$.outboundSchema).optional(),
            raw: z.boolean().nullable().optional(),
