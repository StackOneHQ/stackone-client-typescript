...
export type AtsGetJobPostingRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: AtsGetJobPostingQueryParamProxy | undefined;
    /**
...
export namespace AtsGetJobPostingRequest$ {
    export type Inbound = {
        ...
        proxy?: AtsGetJobPostingQueryParamProxy$.Inbound | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<AtsGetJobPostingRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z.lazy(() => AtsGetJobPostingQueryParamProxy$.inboundSchema).optional(),
    ...
    export type Outbound = {
        ...
        page?: string | null | undefined;
        page_size?: string | null | undefined;
        proxy?: AtsGetJobPostingQueryParamProxy$.Outbound | undefined;
        raw?: boolean | null | undefined;
        sync_token?: string | null | undefined;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AtsGetJobPostingRequest> = z
        .object({
            ...
            proxy: z.lazy(() => AtsGetJobPostingQueryParamProxy$.outboundSchema).optional(),
            raw: z.boolean().nullable().optional(),
