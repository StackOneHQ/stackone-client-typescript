...
export type CrmGetAccountRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: CrmGetAccountQueryParamProxy | undefined;
    /**
...
export namespace CrmGetAccountRequest$ {
    export type Inbound = {
        ...
        proxy?: CrmGetAccountQueryParamProxy$.Inbound | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<CrmGetAccountRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z.lazy(() => CrmGetAccountQueryParamProxy$.inboundSchema).optional(),
    ...
    export type Outbound = {
        ...
        page?: string | null | undefined;
        page_size?: string | null | undefined;
        proxy?: CrmGetAccountQueryParamProxy$.Outbound | undefined;
        raw?: boolean | null | undefined;
        sync_token?: string | null | undefined;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CrmGetAccountRequest> = z
        .object({
            ...
            proxy: z.lazy(() => CrmGetAccountQueryParamProxy$.outboundSchema).optional(),
            raw: z.boolean().nullable().optional(),
