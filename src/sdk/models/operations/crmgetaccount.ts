 ...
 */
export type CrmGetAccountQueryParamProxy = {};
...
export type CrmGetAccountRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: CrmGetAccountQueryParamProxy | null | undefined;
    /**
...
/** @internal */
export namespace CrmGetAccountQueryParamProxy$ {
    export type Inbound = {};

    export const inboundSchema: z.ZodType<CrmGetAccountQueryParamProxy, z.ZodTypeDef, Inbound> =
        z.object({});

    export type Outbound = {};

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CrmGetAccountQueryParamProxy> =
        z.object({});
}
...
export namespace CrmGetAccountRequest$ {
    export type Inbound = {
        ...
        proxy?: CrmGetAccountQueryParamProxy$.Inbound | null | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<CrmGetAccountRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z.nullable(z.lazy(() => CrmGetAccountQueryParamProxy$.inboundSchema)).optional(),
    ...
    export type Outbound = {
        ...
        proxy?: CrmGetAccountQueryParamProxy$.Outbound | null | undefined;
        raw: boolean | null;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    };
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CrmGetAccountRequest> = z
        .object({
            ...
            proxy: z
                .nullable(z.lazy(() => CrmGetAccountQueryParamProxy$.outboundSchema))
                .optional(),
            raw: z.nullable(z.boolean().default(false)),
