 ...
 */
export type AtsListInterviewStagesQueryParamProxy = {};
...
export type AtsListInterviewStagesRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: AtsListInterviewStagesQueryParamProxy | null | undefined;
    /**
...
/** @internal */
export namespace AtsListInterviewStagesQueryParamProxy$ {
    export type Inbound = {};
...
export namespace AtsListInterviewStagesRequest$ {
    export type Inbound = {
        ...
        proxy?: AtsListInterviewStagesQueryParamProxy$.Inbound | null | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<AtsListInterviewStagesRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z
                .nullable(z.lazy(() => AtsListInterviewStagesQueryParamProxy$.inboundSchema))
                .optional(),
    ...
    export type Outbound = {
        ...
        proxy?: AtsListInterviewStagesQueryParamProxy$.Outbound | null | undefined;
        raw: boolean | null;
        sync_token?: string | null | undefined;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AtsListInterviewStagesRequest> =
        z
            .object({
                ...
                proxy: z
                    .nullable(z.lazy(() => AtsListInterviewStagesQueryParamProxy$.outboundSchema))
                    .optional(),
                raw: z.nullable(z.boolean().default(false)),
    ...
    export const inboundSchema: z.ZodType<AtsListInterviewStagesResponse, z.ZodTypeDef, Inbound> = z
        ...
        .transform((v) => {
            return {
                ...
                ...(v.InterviewStagesPaginated === undefined
                    ? null
                    : { interviewStagesPaginated: v.InterviewStagesPaginated }),
