 ...
 */
export type HrisListEmployeeDocumentsQueryParamProxy = {};
...
export type HrisListEmployeeDocumentsRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: HrisListEmployeeDocumentsQueryParamProxy | null | undefined;
    /**
...
/** @internal */
export namespace HrisListEmployeeDocumentsQueryParamProxy$ {
    export type Inbound = {};
...
export namespace HrisListEmployeeDocumentsRequest$ {
    export type Inbound = {
        ...
        proxy?: HrisListEmployeeDocumentsQueryParamProxy$.Inbound | null | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<HrisListEmployeeDocumentsRequest, z.ZodTypeDef, Inbound> =
        z
            .object({
                ...
                proxy: z
                    .nullable(z.lazy(() => HrisListEmployeeDocumentsQueryParamProxy$.inboundSchema))
                    .optional(),
    ...
    export type Outbound = {
        ...
        proxy?: HrisListEmployeeDocumentsQueryParamProxy$.Outbound | null | undefined;
        raw: boolean | null;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    };
    ...
    > = z
        .object({
            ...
            proxy: z
                .nullable(z.lazy(() => HrisListEmployeeDocumentsQueryParamProxy$.outboundSchema))
                .optional(),
            raw: z.nullable(z.boolean().default(false)),
