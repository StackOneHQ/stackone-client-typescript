...
export namespace StackoneListConnectorsMetaRequest$ {
    ...
    export const outboundSchema = StackoneListConnectorsMetaRequest$outboundSchema;
...
export namespace StackoneListConnectorsMetaResponse$ {
    ...
    export const outboundSchema = StackoneListConnectorsMetaResponse$outboundSchema;
