...
export class AtsListApplicationsOffersRequest extends SpeakeasyBase {
    /**
...
export class AtsListApplicationsOffersResponse extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata()
    offersPaginated?: shared.OffersPaginated;
