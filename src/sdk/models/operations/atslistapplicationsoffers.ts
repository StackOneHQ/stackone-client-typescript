 ...
 */
export type AtsListApplicationsOffersQueryParamProxy = {};
...
export type AtsListApplicationsOffersRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: AtsListApplicationsOffersQueryParamProxy | null | undefined;
    /**
...
/** @internal */
export namespace AtsListApplicationsOffersQueryParamProxy$ {
    export type Inbound = {};
...
export namespace AtsListApplicationsOffersRequest$ {
    export type Inbound = {
        ...
        proxy?: AtsListApplicationsOffersQueryParamProxy$.Inbound | null | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<AtsListApplicationsOffersRequest, z.ZodTypeDef, Inbound> =
        z
            .object({
                ...
                proxy: z
                    .nullable(z.lazy(() => AtsListApplicationsOffersQueryParamProxy$.inboundSchema))
                    .optional(),
    ...
    export type Outbound = {
        ...
        proxy?: AtsListApplicationsOffersQueryParamProxy$.Outbound | null | undefined;
        raw: boolean | null;
        sync_token?: string | null | undefined;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    ...
    > = z
        .object({
            ...
            proxy: z
                .nullable(z.lazy(() => AtsListApplicationsOffersQueryParamProxy$.outboundSchema))
                .optional(),
            raw: z.nullable(z.boolean().default(false)),
