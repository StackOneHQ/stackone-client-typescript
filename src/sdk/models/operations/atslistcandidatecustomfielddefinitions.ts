...
export type AtsListCandidateCustomFieldDefinitionsRequest = {
     ...
     * Filter parameters that allow greater customisation of the list response
     */
    filter?: AtsListCandidateCustomFieldDefinitionsQueryParamFilter | null | undefined;
    /**
     * The unified cursor
     */
...
/** @internal */
export const AtsListCandidateCustomFieldDefinitionsQueryParamFilter$inboundSchema: z.ZodType<
...
/** @internal */
export const AtsListCandidateCustomFieldDefinitionsQueryParamFilter$outboundSchema: z.ZodType<
...
export namespace AtsListCandidateCustomFieldDefinitionsQueryParamFilter$ {
    ...
    export type Outbound = AtsListCandidateCustomFieldDefinitionsQueryParamFilter$Outbound;
}

/** @internal */
export const AtsListCandidateCustomFieldDefinitionsRequest$inboundSchema: z.ZodType<
...
> = z
    .object({
        ...
        filter: z
            .nullable(
                z.lazy(() => AtsListCandidateCustomFieldDefinitionsQueryParamFilter$inboundSchema)
            )
            .optional(),
...
export type AtsListCandidateCustomFieldDefinitionsRequest$Outbound = {
    fields?: string | null | undefined;
    filter?: AtsListCandidateCustomFieldDefinitionsQueryParamFilter$Outbound | null | undefined;
    next?: string | null | undefined;
    page?: string | null | undefined;
...
/** @internal */
export const AtsListCandidateCustomFieldDefinitionsRequest$outboundSchema: z.ZodType<
...
> = z
    .object({
        ...
        filter: z
            .nullable(
                z.lazy(() => AtsListCandidateCustomFieldDefinitionsQueryParamFilter$outboundSchema)
            )
            .optional(),
        next: z.nullable(z.string()).optional(),
        page: z.nullable(z.string()).optional(),
...
export namespace AtsListCandidateCustomFieldDefinitionsRequest$ {
    ...
    export const inboundSchema = AtsListCandidateCustomFieldDefinitionsRequest$inboundSchema;
    /** @deprecated use `AtsListCandidateCustomFieldDefinitionsRequest$outboundSchema` instead. */
    export const outboundSchema = AtsListCandidateCustomFieldDefinitionsRequest$outboundSchema;
...
/** @internal */
export const AtsListCandidateCustomFieldDefinitionsResponse$inboundSchema: z.ZodType<
...
/** @internal */
export const AtsListCandidateCustomFieldDefinitionsResponse$outboundSchema: z.ZodType<
...
export namespace AtsListCandidateCustomFieldDefinitionsResponse$ {
    ...
    export const inboundSchema = AtsListCandidateCustomFieldDefinitionsResponse$inboundSchema;
    /** @deprecated use `AtsListCandidateCustomFieldDefinitionsResponse$outboundSchema` instead. */
    export const outboundSchema = AtsListCandidateCustomFieldDefinitionsResponse$outboundSchema;
    /** @deprecated use `AtsListCandidateCustomFieldDefinitionsResponse$Outbound` instead. */
    export type Outbound = AtsListCandidateCustomFieldDefinitionsResponse$Outbound;
}
