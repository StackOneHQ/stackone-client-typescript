...
export type MarketingCreateInAppTemplateRequest = {
    marketingCreateInAppTemplateRequestDto: shared.MarketingCreateInAppTemplateRequestDto;
    /**
...
export type MarketingCreateInAppTemplateRequest$Outbound = {
    MarketingCreateInAppTemplateRequestDto: shared.MarketingCreateInAppTemplateRequestDto$Outbound;
    "x-account-id": string;
};
...
export namespace MarketingCreateInAppTemplateRequest$ {
    ...
    export const inboundSchema = MarketingCreateInAppTemplateRequest$inboundSchema;
    /** @deprecated use `MarketingCreateInAppTemplateRequest$outboundSchema` instead. */
    export const outboundSchema = MarketingCreateInAppTemplateRequest$outboundSchema;
...
export namespace MarketingCreateInAppTemplateResponse$ {
    ...
    export const inboundSchema = MarketingCreateInAppTemplateResponse$inboundSchema;
    /** @deprecated use `MarketingCreateInAppTemplateResponse$outboundSchema` instead. */
    export const outboundSchema = MarketingCreateInAppTemplateResponse$outboundSchema;
