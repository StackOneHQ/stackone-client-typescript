 ...
 */
export type AtsGetInterviewQueryParamProxy = {};
...
export type AtsGetInterviewRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: AtsGetInterviewQueryParamProxy | null | undefined;
    /**
...
/** @internal */
export namespace AtsGetInterviewQueryParamProxy$ {
    export type Inbound = {};

    export const inboundSchema: z.ZodType<AtsGetInterviewQueryParamProxy, z.ZodTypeDef, Inbound> =
        z.object({});

    export type Outbound = {};

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AtsGetInterviewQueryParamProxy> =
        z.object({});
}
...
export namespace AtsGetInterviewRequest$ {
    export type Inbound = {
        ...
        proxy?: AtsGetInterviewQueryParamProxy$.Inbound | null | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<AtsGetInterviewRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z
                .nullable(z.lazy(() => AtsGetInterviewQueryParamProxy$.inboundSchema))
                .optional(),
    ...
    export type Outbound = {
        ...
        proxy?: AtsGetInterviewQueryParamProxy$.Outbound | null | undefined;
        raw: boolean | null;
        sync_token?: string | null | undefined;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AtsGetInterviewRequest> = z
        .object({
            ...
            proxy: z
                .nullable(z.lazy(() => AtsGetInterviewQueryParamProxy$.outboundSchema))
                .optional(),
            raw: z.nullable(z.boolean().default(false)),
