...
export namespace LmsListAssignmentsQueryParamFilter$ {
    ...
    export const outboundSchema = LmsListAssignmentsQueryParamFilter$outboundSchema;
...
> = z
    .object({
        ...
        filter: z
            .nullable(z.lazy(() => LmsListAssignmentsQueryParamFilter$inboundSchema))
            .optional(),
        id: z.string(),
...
> = z
    .object({
        fields: z.nullable(z.string()).optional(),
        filter: z
            .nullable(z.lazy(() => LmsListAssignmentsQueryParamFilter$outboundSchema))
            .optional(),
        id: z.string(),
        next: z.nullable(z.string()).optional(),
        page: z.nullable(z.string()).optional(),
