...
export namespace MarketingUpdateInAppTemplateRequest$ {
    ...
    export const inboundSchema = MarketingUpdateInAppTemplateRequest$inboundSchema;
    /** @deprecated use `MarketingUpdateInAppTemplateRequest$outboundSchema` instead. */
    export const outboundSchema = MarketingUpdateInAppTemplateRequest$outboundSchema;
...
export namespace MarketingUpdateInAppTemplateResponse$ {
    ...
    export const inboundSchema = MarketingUpdateInAppTemplateResponse$inboundSchema;
    /** @deprecated use `MarketingUpdateInAppTemplateResponse$outboundSchema` instead. */
    export const outboundSchema = MarketingUpdateInAppTemplateResponse$outboundSchema;
