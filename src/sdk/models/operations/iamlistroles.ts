 ...
 */
export type IamListRolesQueryParamProxy = {};
...
export type IamListRolesRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with 'proxy' key
     */
    proxy?: IamListRolesQueryParamProxy | null | undefined;
    /**
...
/** @internal */
export namespace IamListRolesQueryParamProxy$ {
    export type Inbound = {};

    export const inboundSchema: z.ZodType<IamListRolesQueryParamProxy, z.ZodTypeDef, Inbound> =
        z.object({});

    export type Outbound = {};

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, IamListRolesQueryParamProxy> =
        z.object({});
}
...
export namespace IamListRolesRequest$ {
    export type Inbound = {
        ...
        proxy?: IamListRolesQueryParamProxy$.Inbound | null | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<IamListRolesRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z.nullable(z.lazy(() => IamListRolesQueryParamProxy$.inboundSchema)).optional(),
    ...
    export type Outbound = {
        ...
        proxy?: IamListRolesQueryParamProxy$.Outbound | null | undefined;
        raw: boolean | null;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    };
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, IamListRolesRequest> = z
        .object({
            ...
            proxy: z.nullable(z.lazy(() => IamListRolesQueryParamProxy$.outboundSchema)).optional(),
            raw: z.nullable(z.boolean().default(false)),
