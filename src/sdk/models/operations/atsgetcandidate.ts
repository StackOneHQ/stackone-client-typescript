...
export type AtsGetCandidateRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: AtsGetCandidateQueryParamProxy | undefined;
    /**
...
export namespace AtsGetCandidateRequest$ {
    export type Inbound = {
        ...
        proxy?: AtsGetCandidateQueryParamProxy$.Inbound | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<AtsGetCandidateRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z.lazy(() => AtsGetCandidateQueryParamProxy$.inboundSchema).optional(),
    ...
    export type Outbound = {
        ...
        page?: string | null | undefined;
        page_size?: string | null | undefined;
        proxy?: AtsGetCandidateQueryParamProxy$.Outbound | undefined;
        raw?: boolean | null | undefined;
        sync_token?: string | null | undefined;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AtsGetCandidateRequest> = z
        .object({
            ...
            proxy: z.lazy(() => AtsGetCandidateQueryParamProxy$.outboundSchema).optional(),
            raw: z.boolean().nullable().optional(),
