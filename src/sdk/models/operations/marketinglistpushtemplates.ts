 ...
 */
export type MarketingListPushTemplatesQueryParamProxy = {};
...
export type MarketingListPushTemplatesRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: MarketingListPushTemplatesQueryParamProxy | null | undefined;
    /**
...
/** @internal */
export namespace MarketingListPushTemplatesQueryParamProxy$ {
    export type Inbound = {};
...
export namespace MarketingListPushTemplatesRequest$ {
    export type Inbound = {
        ...
        proxy?: MarketingListPushTemplatesQueryParamProxy$.Inbound | null | undefined;
        raw?: boolean | null | undefined;
    ...
    > = z
        .object({
            ...
            proxy: z
                .nullable(z.lazy(() => MarketingListPushTemplatesQueryParamProxy$.inboundSchema))
                .optional(),
    ...
    export type Outbound = {
        ...
        page?: string | null | undefined;
        page_size?: string | null | undefined;
        proxy?: MarketingListPushTemplatesQueryParamProxy$.Outbound | null | undefined;
        raw?: boolean | null | undefined;
        sync_token?: string | null | undefined;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    ...
    > = z
        .object({
            ...
            proxy: z
                .nullable(z.lazy(() => MarketingListPushTemplatesQueryParamProxy$.outboundSchema))
                .optional(),
            raw: z.nullable(z.boolean()).optional(),
