 ...
 */
export type IamGetPolicyQueryParamProxy = {};
...
export type IamGetPolicyRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with 'proxy' key
     */
    proxy?: IamGetPolicyQueryParamProxy | null | undefined;
    /**
...
/** @internal */
export namespace IamGetPolicyQueryParamProxy$ {
    export type Inbound = {};

    export const inboundSchema: z.ZodType<IamGetPolicyQueryParamProxy, z.ZodTypeDef, Inbound> =
        z.object({});

    export type Outbound = {};

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, IamGetPolicyQueryParamProxy> =
        z.object({});
}
...
export namespace IamGetPolicyRequest$ {
    export type Inbound = {
        ...
        proxy?: IamGetPolicyQueryParamProxy$.Inbound | null | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<IamGetPolicyRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z.nullable(z.lazy(() => IamGetPolicyQueryParamProxy$.inboundSchema)).optional(),
    ...
    export type Outbound = {
        ...
        proxy?: IamGetPolicyQueryParamProxy$.Outbound | null | undefined;
        raw: boolean | null;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    };
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, IamGetPolicyRequest> = z
        .object({
            ...
            proxy: z.nullable(z.lazy(() => IamGetPolicyQueryParamProxy$.outboundSchema)).optional(),
            raw: z.nullable(z.boolean().default(false)),
