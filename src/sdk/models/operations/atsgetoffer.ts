...
export type AtsGetOfferRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: AtsGetOfferQueryParamProxy | undefined;
    /**
...
export namespace AtsGetOfferRequest$ {
    export type Inbound = {
        ...
        proxy?: AtsGetOfferQueryParamProxy$.Inbound | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<AtsGetOfferRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z.lazy(() => AtsGetOfferQueryParamProxy$.inboundSchema).optional(),
    ...
    export type Outbound = {
        ...
        page?: string | null | undefined;
        page_size?: string | null | undefined;
        proxy?: AtsGetOfferQueryParamProxy$.Outbound | undefined;
        raw?: boolean | null | undefined;
        sync_token?: string | null | undefined;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AtsGetOfferRequest> = z
        .object({
            ...
            proxy: z.lazy(() => AtsGetOfferQueryParamProxy$.outboundSchema).optional(),
            raw: z.boolean().nullable().optional(),
