 ...
 */
export type IamListPoliciesQueryParamProxy = {};
...
export type IamListPoliciesRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with 'proxy' key
     */
    proxy?: IamListPoliciesQueryParamProxy | null | undefined;
    /**
...
/** @internal */
export namespace IamListPoliciesQueryParamProxy$ {
    export type Inbound = {};

    export const inboundSchema: z.ZodType<IamListPoliciesQueryParamProxy, z.ZodTypeDef, Inbound> =
        z.object({});

    export type Outbound = {};

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, IamListPoliciesQueryParamProxy> =
        z.object({});
}
...
export namespace IamListPoliciesRequest$ {
    export type Inbound = {
        ...
        proxy?: IamListPoliciesQueryParamProxy$.Inbound | null | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<IamListPoliciesRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z
                .nullable(z.lazy(() => IamListPoliciesQueryParamProxy$.inboundSchema))
                .optional(),
    ...
    export type Outbound = {
        ...
        proxy?: IamListPoliciesQueryParamProxy$.Outbound | null | undefined;
        raw: boolean | null;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    };
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, IamListPoliciesRequest> = z
        .object({
            ...
            proxy: z
                .nullable(z.lazy(() => IamListPoliciesQueryParamProxy$.outboundSchema))
                .optional(),
            raw: z.nullable(z.boolean().default(false)),
