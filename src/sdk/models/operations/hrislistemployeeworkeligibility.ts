 ...
 */
export type HrisListEmployeeWorkEligibilityQueryParamProxy = {};
...
export type HrisListEmployeeWorkEligibilityRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with 'proxy' key
     */
    proxy?: HrisListEmployeeWorkEligibilityQueryParamProxy | null | undefined;
    /**
...
/** @internal */
export namespace HrisListEmployeeWorkEligibilityQueryParamProxy$ {
    export type Inbound = {};
...
export namespace HrisListEmployeeWorkEligibilityRequest$ {
    export type Inbound = {
        ...
        proxy?: HrisListEmployeeWorkEligibilityQueryParamProxy$.Inbound | null | undefined;
        raw?: boolean | null | undefined;
    ...
    > = z
        .object({
            ...
            proxy: z
                .nullable(
                    z.lazy(() => HrisListEmployeeWorkEligibilityQueryParamProxy$.inboundSchema)
                )
                .optional(),
    ...
    export type Outbound = {
        ...
        proxy?: HrisListEmployeeWorkEligibilityQueryParamProxy$.Outbound | null | undefined;
        raw: boolean | null;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    };
    ...
    > = z
        .object({
            ...
            proxy: z
                .nullable(
                    z.lazy(() => HrisListEmployeeWorkEligibilityQueryParamProxy$.outboundSchema)
                )
                .optional(),
            raw: z.nullable(z.boolean().default(false)),
