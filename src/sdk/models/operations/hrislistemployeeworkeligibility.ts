...
/** @internal */
export const HrisListEmployeeWorkEligibilityQueryParamFilter$inboundSchema: z.ZodType<
...
/** @internal */
export const HrisListEmployeeWorkEligibilityQueryParamFilter$outboundSchema: z.ZodType<
...
export namespace HrisListEmployeeWorkEligibilityQueryParamFilter$ {
    ...
    export const inboundSchema = HrisListEmployeeWorkEligibilityQueryParamFilter$inboundSchema;
    /** @deprecated use `HrisListEmployeeWorkEligibilityQueryParamFilter$outboundSchema` instead. */
    export const outboundSchema = HrisListEmployeeWorkEligibilityQueryParamFilter$outboundSchema;
    /** @deprecated use `HrisListEmployeeWorkEligibilityQueryParamFilter$Outbound` instead. */
    export type Outbound = HrisListEmployeeWorkEligibilityQueryParamFilter$Outbound;
}
...
> = z
    .object({
        ...
        filter: z
            .nullable(z.lazy(() => HrisListEmployeeWorkEligibilityQueryParamFilter$inboundSchema))
            .optional(),
        id: z.string(),
...
export type HrisListEmployeeWorkEligibilityRequest$Outbound = {
    fields?: string | null | undefined;
    filter?: HrisListEmployeeWorkEligibilityQueryParamFilter$Outbound | null | undefined;
    id: string;
    next?: string | null | undefined;
    page?: string | null | undefined;
...
> = z
    .object({
        fields: z.nullable(z.string()).optional(),
        filter: z
            .nullable(z.lazy(() => HrisListEmployeeWorkEligibilityQueryParamFilter$outboundSchema))
            .optional(),
        id: z.string(),
        next: z.nullable(z.string()).optional(),
        page: z.nullable(z.string()).optional(),
...
export namespace HrisListEmployeeWorkEligibilityRequest$ {
    ...
    export const inboundSchema = HrisListEmployeeWorkEligibilityRequest$inboundSchema;
    /** @deprecated use `HrisListEmployeeWorkEligibilityRequest$outboundSchema` instead. */
    export const outboundSchema = HrisListEmployeeWorkEligibilityRequest$outboundSchema;
...
export namespace HrisListEmployeeWorkEligibilityResponse$ {
    ...
    export const inboundSchema = HrisListEmployeeWorkEligibilityResponse$inboundSchema;
    /** @deprecated use `HrisListEmployeeWorkEligibilityResponse$outboundSchema` instead. */
    export const outboundSchema = HrisListEmployeeWorkEligibilityResponse$outboundSchema;
