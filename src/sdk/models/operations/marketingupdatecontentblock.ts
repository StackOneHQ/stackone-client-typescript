...
export namespace MarketingUpdateContentBlockRequest$ {
    ...
    export const outboundSchema = MarketingUpdateContentBlockRequest$outboundSchema;
...
export namespace MarketingUpdateContentBlockResponse$ {
    ...
    export const inboundSchema = MarketingUpdateContentBlockResponse$inboundSchema;
    /** @deprecated use `MarketingUpdateContentBlockResponse$outboundSchema` instead. */
    export const outboundSchema = MarketingUpdateContentBlockResponse$outboundSchema;
