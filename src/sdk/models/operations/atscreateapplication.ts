...
export class AtsCreateApplicationRequest extends SpeakeasyBase {
...
export class AtsCreateApplicationResponse extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata()
    createResult?: shared.CreateResult;
