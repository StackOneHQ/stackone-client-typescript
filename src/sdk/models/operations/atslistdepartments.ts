 ...
 */
export type AtsListDepartmentsQueryParamProxy = {};
...
export type AtsListDepartmentsRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with "proxy" key
     */
    proxy?: AtsListDepartmentsQueryParamProxy | null | undefined;
    /**
...
/** @internal */
export namespace AtsListDepartmentsQueryParamProxy$ {
    export type Inbound = {};
...
export namespace AtsListDepartmentsRequest$ {
    export type Inbound = {
        ...
        proxy?: AtsListDepartmentsQueryParamProxy$.Inbound | null | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<AtsListDepartmentsRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z
                .nullable(z.lazy(() => AtsListDepartmentsQueryParamProxy$.inboundSchema))
                .optional(),
    ...
    export type Outbound = {
        ...
        proxy?: AtsListDepartmentsQueryParamProxy$.Outbound | null | undefined;
        raw: boolean | null;
        sync_token?: string | null | undefined;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AtsListDepartmentsRequest> = z
        .object({
            fields: z.nullable(z.string()).optional(),
            next: z.nullable(z.string()).optional(),
            page: z.nullable(z.string()).optional(),
            ...
            proxy: z
                .nullable(z.lazy(() => AtsListDepartmentsQueryParamProxy$.outboundSchema))
                .optional(),
            raw: z.nullable(z.boolean().default(false)),
...
export namespace AtsListDepartmentsResponse$ {
    ...
    export const inboundSchema: z.ZodType<AtsListDepartmentsResponse, z.ZodTypeDef, Inbound> = z
        ...
        .transform((v) => {
            return {
                ...
                ...(v.DepartmentsPaginated === undefined
                    ? null
                    : { departmentsPaginated: v.DepartmentsPaginated }),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AtsListDepartmentsResponse> = z
        .object({
            contentType: z.string(),
