...
/** @internal */
export const AtsGetCandidateCustomFieldDefinitionRequest$inboundSchema: z.ZodType<
...
/** @internal */
export const AtsGetCandidateCustomFieldDefinitionRequest$outboundSchema: z.ZodType<
...
export namespace AtsGetCandidateCustomFieldDefinitionRequest$ {
    ...
    export const inboundSchema = AtsGetCandidateCustomFieldDefinitionRequest$inboundSchema;
    /** @deprecated use `AtsGetCandidateCustomFieldDefinitionRequest$outboundSchema` instead. */
    export const outboundSchema = AtsGetCandidateCustomFieldDefinitionRequest$outboundSchema;
...
/** @internal */
export const AtsGetCandidateCustomFieldDefinitionResponse$inboundSchema: z.ZodType<
...
/** @internal */
export const AtsGetCandidateCustomFieldDefinitionResponse$outboundSchema: z.ZodType<
...
export namespace AtsGetCandidateCustomFieldDefinitionResponse$ {
    ...
    export const inboundSchema = AtsGetCandidateCustomFieldDefinitionResponse$inboundSchema;
    /** @deprecated use `AtsGetCandidateCustomFieldDefinitionResponse$outboundSchema` instead. */
    export const outboundSchema = AtsGetCandidateCustomFieldDefinitionResponse$outboundSchema;
