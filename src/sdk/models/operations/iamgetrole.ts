 ...
 */
export type IamGetRoleQueryParamProxy = {};
...
export type IamGetRoleRequest = {
     ...
     * Query parameters that can be used to pass through parameters to the underlying provider request by surrounding them with 'proxy' key
     */
    proxy?: IamGetRoleQueryParamProxy | null | undefined;
    /**
...
/** @internal */
export namespace IamGetRoleQueryParamProxy$ {
    export type Inbound = {};

    export const inboundSchema: z.ZodType<IamGetRoleQueryParamProxy, z.ZodTypeDef, Inbound> =
        z.object({});

    export type Outbound = {};

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, IamGetRoleQueryParamProxy> =
        z.object({});
}
...
export namespace IamGetRoleRequest$ {
    export type Inbound = {
        ...
        proxy?: IamGetRoleQueryParamProxy$.Inbound | null | undefined;
        raw?: boolean | null | undefined;
    ...
    export const inboundSchema: z.ZodType<IamGetRoleRequest, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            proxy: z.nullable(z.lazy(() => IamGetRoleQueryParamProxy$.inboundSchema)).optional(),
    ...
    export type Outbound = {
        ...
        proxy?: IamGetRoleQueryParamProxy$.Outbound | null | undefined;
        raw: boolean | null;
        updated_after?: string | null | undefined;
        "x-account-id": string;
    };
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, IamGetRoleRequest> = z
        .object({
            ...
            proxy: z.nullable(z.lazy(() => IamGetRoleQueryParamProxy$.outboundSchema)).optional(),
            raw: z.nullable(z.boolean().default(false)),
