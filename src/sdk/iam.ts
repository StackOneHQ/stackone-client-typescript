...
import { iamDeleteUser } from "../funcs/iamDeleteUser.js";
...
import { iamUpdateUser } from "../funcs/iamUpdateUser.js";
...
export class Iam extends ClientSDK {
   ...
   */
  async deleteUser(
    request: operations.IamDeleteUserRequest,
    options?: RequestOptions,
  ): Promise<operations.IamDeleteUserResponse> {
    return unwrapAsync(iamDeleteUser(
      this,
      request,
      options,
    ));
  ...
  async updateUser(
    ...
    options?: RequestOptions,
  ): Promise<operations.IamUpdateUserResponse> {
    return unwrapAsync(iamUpdateUser(
      this,
      request,
      options,
    ));
