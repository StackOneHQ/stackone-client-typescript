...
export class Marketing extends ClientSDK {
    ...
    async createInAppTemplate(
        ...
        const path$ = this.templateURLComponent("/unified/marketing/templates/in_app")();
        ...
        const [result$] = await this.matcher<operations.MarketingCreateInAppTemplateResponse>()
            .json(201, operations.MarketingCreateInAppTemplateResponse$inboundSchema, {
                key: "CreateResult",
            })
            .fail([400, 403, 412, 429, "4XX", 500, 501, "5XX"])
            .match(response, { extraFields: responseFields$ });
    ...
    async getInAppTemplate(
        ...
        const path$ = this.templateURLComponent("/unified/marketing/templates/in_app/{id}")(
            pathParams$
        );
        ...
        const [result$] = await this.matcher<operations.MarketingGetInAppTemplateResponse>()
            .json(200, operations.MarketingGetInAppTemplateResponse$inboundSchema, {
                key: "TemplateResult",
            })
            .fail([400, 403, 412, 429, "4XX", 500, 501, "5XX"])
            .match(response, { extraFields: responseFields$ });
    ...
    async listInAppTemplates(
        ...
        const [result$] = await this.matcher<operations.MarketingListInAppTemplatesResponse>()
            .json(200, operations.MarketingListInAppTemplatesResponse$inboundSchema, {
                key: "TemplatesPaginated",
            })
            .fail([400, 403, 412, 429, "4XX", 500, 501, "5XX"])
            .match(response, { extraFields: responseFields$ });
    ...
    async updateInAppTemplate(
        ...
        const [result$] = await this.matcher<operations.MarketingUpdateInAppTemplateResponse>()
            .json(200, operations.MarketingUpdateInAppTemplateResponse$inboundSchema, {
                key: "CreateResult",
            })
            .fail([400, 403, 412, 429, "4XX", 500, 501, "5XX"])
            .match(response, { extraFields: responseFields$ });
